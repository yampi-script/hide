	...
	static public function mdlMostrarPolicias($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT *
													...
													FROM fiscales a WHERE $item = :valor");
...
/*=============================================
	...
	static public function mdlMostrarFiscalesID($item, $valor){
		...
		$stmt = Conexion::conectar()->prepare("SELECT id
			...
			,personal_f1_fisdelminisp_M
			,personal_f1_fisdelminisp_H
			,personal_f1_fisdelminisp_T

			,personal_f1_agenminpu_M
			,personal_f1_agenminpu_H
			,personal_f1_agenminpu_T


			,personal_f1_secminpu_M
			,personal_f1_secminpu_H
			,personal_f1_secminpu_T

			,personal_f1_peri_M
			,personal_f1_peri_H
			,personal_f1_peri_T

			,personal_f1_pomininvjud_M
			,personal_f1_pomininvjud_H
			,personal_f1_pomininvjud_T
			...
			,personal_f1_siningre_M
			,personal_f1_siningre_H
			,personal_f1_siningre_T

			,personal_f1_de1a5000_M
			,personal_f1_de1a5000_H
			,personal_f1_de1a5000_T

			,personal_f1_de5001a10000_M
			,personal_f1_de5001a10000_H
			,personal_f1_de5001a10000_T

			,personal_f1_de10001a15000_M
			,personal_f1_de10001a15000_H
			,personal_f1_de10001a15000_T

			,personal_f1_de15001a20000_M
			,personal_f1_de15001a20000_H
			,personal_f1_de15001a20000_T

			,personal_f1_de20001a25000_M
			,personal_f1_de20001a25000_H
			,personal_f1_de20001a25000_T

			,personal_f1_de25001a30000_M
			,personal_f1_de25001a30000_H
			,personal_f1_de25001a30000_T

			,personal_f1_de30001a35000_M
			,personal_f1_de30001a35000_H
			,personal_f1_de30001a35000_T

			,personal_f1_de35001a40000_M
			,personal_f1_de35001a40000_H
			,personal_f1_de35001a40000_T

			,personal_f1_de40001a45000_M
			,personal_f1_de40001a45000_H
			,personal_f1_de40001a45000_T

			,personal_f1_de45001a50000_M
			,personal_f1_de45001a50000_H
			,personal_f1_de45001a50000_T

			,personal_f1_masde50000_M
			,personal_f1_masde50000_H
			,personal_f1_masde50000_T
			,personal_f1_2_nosesabe



			,personal_f1_2_ning_M
			,personal_f1_2_ning_H
			,personal_f1_2_ning_T

			,personal_f1_2_prees_M
			,personal_f1_2_prees_H
			,personal_f1_2_prees_T

			,personal_f1_2_prim_M
			,personal_f1_2_prim_H
			,personal_f1_2_prim_T

			,personal_f1_2_secu_M
			,personal_f1_2_secu_H
			,personal_f1_2_secu_T

			,personal_f1_2_ctsect_M
			,personal_f1_2_ctsect_H
			,personal_f1_2_ctsect_T

			,personal_f1_2_nbasica_M
			,personal_f1_2_nbasica_H
			,personal_f1_2_nbasica_T

			,personal_f1_2_preobach_M
			,personal_f1_2_preobach_H
			,personal_f1_2_preobach_T

			,personal_f1_2_ctcpret_M
			,personal_f1_2_ctcpret_H
			,personal_f1_2_ctcpret_T

			,personal_f1_2_licoprof_M
			,personal_f1_2_licoprof_H
			,personal_f1_2_licoprof_T

			,personal_f1_2_maesdoc_M
			,personal_f1_2_maesdoc_H
			,personal_f1_2_maesdoc_T


			,capacitacion_f2_fiscminpubli_M
			,capacitacion_f2_fiscminpubli_H
			,capacitacion_f2_fiscminpubli_T

			,capacitacion_f2_ageminpubli_M
			,capacitacion_f2_ageminpubli_H
			,capacitacion_f2_ageminpubli_T

			,capacitacion_f2_secminpubli_M
			,capacitacion_f2_secminpubli_H
			,capacitacion_f2_secminpubli_T

			,capacitacion_f2_perito_M
			,capacitacion_f2_perito_H
			,capacitacion_f2_perito_T

			,capacitacion_f2_polimininvjud_M
			,capacitacion_f2_polimininvjud_H
			,capacitacion_f2_polimininvjud_T

			,capacitacion_f2_otrosT
			,capacitacion_f2_otros_M
			,capacitacion_f2_otros_H
			,capacitacion_f2_otros_T

			,capacitacion_f2_1_sisjustpenalacus_M
			,capacitacion_f2_1_sisjustpenalacus_H
			,capacitacion_f2_1_sisjustpenalacus_T

			,capacitacion_f2_1_debproc_M
			,capacitacion_f2_1_debproc_H
			,capacitacion_f2_1_debproc_T

			,capacitacion_f2_1_femini_M
			,capacitacion_f2_1_femini_H
			,capacitacion_f2_1_femini_T

			,capacitacion_f2_1_vioconmuj_M
			,capacitacion_f2_1_vioconmuj_H
			,capacitacion_f2_1_vioconmuj_T

			,capacitacion_f2_1_antratpers_M
			,capacitacion_f2_1_antratpers_H
			,capacitacion_f2_1_antratpers_T

			,capacitacion_f2_1_tort_M
			,capacitacion_f2_1_tort_H
			,capacitacion_f2_1_tort_T

			,capacitacion_f2_1_porinf_M
			,capacitacion_f2_1_porinf_H
			,capacitacion_f2_1_porinf_T

			,capacitacion_f2_1_asiconextra_M
			,capacitacion_f2_1_asiconextra_H
			,capacitacion_f2_1_asiconextra_T

			,capacitacion_f2_1_sisjustpenad_M
			,capacitacion_f2_1_sisjustpenad_H
			,capacitacion_f2_1_sisjustpenad_T

			,capacitacion_f2_1_ateperin_M
			,capacitacion_f2_1_ateperin_H
			,capacitacion_f2_1_ateperin_T

			,capacitacion_f2_1_ateperdis_M
			,capacitacion_f2_1_ateperdis_H
			,capacitacion_f2_1_ateperdis_T

			,capacitacion_f2_1_justalt_M
			,capacitacion_f2_1_justalt_H
			,capacitacion_f2_1_justalt_T

			,capacitacion_f2_1_justtera_M
			,capacitacion_f2_1_justtera_H
			,capacitacion_f2_1_justtera_T


			,capacitacion_f2_1_justtran_M
			,capacitacion_f2_1_justtran_H
			,capacitacion_f2_1_justtran_T

			,capacitacion_f2_1_repaintdan_M
			,capacitacion_f2_1_repaintdan_H
			,capacitacion_f2_1_repaintdan_T

			,capacitacion_f2_1_otros
			,capacitacion_f2_1_otros_M
			,capacitacion_f2_1_otros_H
			,capacitacion_f2_1_otros_T

			,capacitacion_f2_1_noaplica
			,capacitacion_f2_2_nosesabe

			,capacitacion_p2_2_instiorg
			,presupuesto_f3
			,presupuesto_f3_p3_1
			,presupuesto_f3_p3_2
      ...
      ,indigenas_p6_1_tsotsil_M
		  ...
		  ,indigenas_p6_6_cualbuenaspra
			...
			,extranjeras_f7_tradLenExt

			,extranjeras_f7_1_ingles_M
			,extranjeras_f7_1_ingles_H
			,extranjeras_f7_1_ingles_T

			,extranjeras_f7_1_chino_M
			,extranjeras_f7_1_chino_H
			,extranjeras_f7_1_chino_T

			,extranjeras_f7_1_frances_M
			,extranjeras_f7_1_frances_H
			,extranjeras_f7_1_frances_T

			,extranjeras_f7_1_arabe_M
			,extranjeras_f7_1_arabe_H
			,extranjeras_f7_1_arabe_T

			,extranjeras_f7_1_otro
			,extranjeras_f7_1_otro_M
			,extranjeras_f7_1_otro_H
			,extranjeras_f7_1_otro_T

			,extranjeras_f7_1_noaplica
			,extranjeras_f7_1_nosesabe

			,extranjeras_f7_2_ConvInst
			,extranjeras_f7_3_nombreInsti

			,extranjeras_f7_4_ProtoInterna
			,extranjeras_f7_4_ProtoInterna_cual

			,extranjeras_f7_4_interno
			,extranjeras_f7_4_interno_cual

			,extranjeras_f7_4_ninguno
			,extranjeras_f7_4_Otro
			,extranjeras_f7_4_Otro_cual
			,extranjeras_f7_4_nosesabe

			,extranjeras_f7_5_buenasprac

			,extranjeras_f7_6_buenasprac_cual
			,extranjeras_f7_6_nosesabe

			,discapacidad_f8_braile
			,discapacidad_f8_LenSen

			,discapacidad_f8_1_nombreInst
			,extranjeras_f8_1_noaplica
			,extranjeras_f8_1_nosesabe

			,discapacidad_f8_2_ProtoInterna
			,discapacidad_f8_2_ProtoInterna_cual
      ,discapacidad_f8_2_interno
			,discapacidad_f8_2_ProtoImpJust
			,discapacidad_f8_2_ninguno
			,discapacidad_f8_2_otros
			,discapacidad_f8_2_otros_cual
			,extranjeras_f8_2_nosesabe

			,discapacidad_f8_3_buenasprac

			,discapacidad_f8_3_buenasprac_cual
      ...
      /*¿Con qué protocolos cuenta la institución para garantizar los derechos de las mujeres?*/
			,mujeres_f4_protoInter
			,mujeres_f4_protoInter_cual
			,mujeres_f4_interno
			,mujeres_f4_interno_cua
			,mujeres_f4_protoInvmpp
			,mujeres_f4_protoscjnjpg
			,mujeres_f4_ninguno
			,mujeres_f4_otroProto
			,mujeres_f4_otroProto_cual

			/*¿La institución cuenta con buenas prácticas que considere sean innovadoras para mejorar el acceso a la justicia a mujeres?*/
			,mujeres_f4_1_buenprac

			/*¿Cuáles son esas buenas prácticas?*/
			,mujeres_f4_2_cualBuenprac

			/*Total de personal capacitado en justicia para mujeres. Desglosar por sexo.*/
			,mujeres_f4_3_justmuj_M
			,mujeres_f4_3_justmuj_H
			,mujeres_f4_3_justmuj_T

			/*En caso de no contar con personal capacitado en justicia para mujeres ¿qué acciones se están
			 implementando para la atención de víctimas y la investigación de delitos con perspectiva de género?*/
			 ,mujeres_f4_4_percapjusmuj

			/*¿Con qué protocolos cuenta la institución para garantizar los derechos de niñas, niños y adolescentes?*/
			,ja_f5_protoInter
      ,ja_f5_protoInter_cual
      ,ja_f5_interno
      ,ja_f5_interno_cua
      ,ja_f5_protoAtennavicdel
      ,ja_f5_delconvul
      ,ja_f5_ninguno
      ,ja_f5_otroProto
      ,ja_f5_otroProto_cual

			/*¿La institución cuenta con buenas prácticas que considere sean
			 innovadoras para mejorar el acceso a la justicia a niñas, niños y adolescentes?*/
			 ,ja_f5_1_buenprac

			/*¿Cuáles son esas buenas prácticas?*/
			,	ja_f5_2_cualBuenprac

			/*¿Cuentan con una fiscalía/agencia/unidad/dirección especializada en justicia para adolescentes?*/
			,ja_f5_3_fisagemundir

			/*Total de personal de fiscalía/agencia/unidad/dirección
			especializada que se encuentra especializado en justicia para adolescentes. Desglosar por sexo.*/
			,ja_f5_4_fisagemundir

			/*Total de personal de la Fiscalía General del Estado especializado en justicia para adolescentes. Desglosar por sexo.*/
			,ja_f5_5_totperfisgen_M
      ,ja_f5_5_totperfisgen_H
      ,ja_f5_5_totperfisgen_T

			/*¿Cuentan con intérpretes/traductores de lenguas indígenas?
(Justicia para personas indïgenas)*/
      ,indigenas_f6_inttrleind

			/*¿Con cuántos intérpretes/traductores cuenta la institución? Desglosar por lengua indígena y por sexo.*/
			,indigenas_f6_1_nahuatl_M
      ,indigenas_f6_1_nahuatl_H
      ,indigenas_f6_1_nahuatl_T
      ,indigenas_f6_1_Maya_M
      ,indigenas_f6_1_Maya_H
      ,indigenas_f6_1_Maya_T
      ,indigenas_f6_1_Tseltal_M
      ,indigenas_f6_1_Tseltal_H
      ,indigenas_f6_1_Tseltal_T
      ,indigenas_f6_1_Mixteco_M
      ,indigenas_f6_1_Mixteco_H
      ,indigenas_f6_1_Mixteco_T
      ,indigenas_f6_1_Tsotsil_M
      ,indigenas_f6_1_Tsotsil_H
      ,indigenas_f6_1_Tsotsil_T
      ,indigenas_f6_1_otro
      ,indigenas_f6_1_otro_M
      ,indigenas_f6_1_otro_H
      ,indigenas_f6_1_otro_T

			/*¿Tienen convenios con alguna institución que provea este servicio?*/
			,indigenas_f6_2_coninsser

			/*¿Cuál es el nombre de la institución o instituciones?*/
			,indigenas_f6_3_nomins

			/*¿Con qué protocolos cuenta la institución para garantizar los derechos de las personas indígenas?*/
			,indigenas_f6_4_protoInter
      ,indigenas_f6_4_protoInter_cual
      ,indigenas_f6_4_interno
      ,indigenas_f6_4_interno_cua
      ,indigenas_f6_4_scjn
      ,indigenas_f6_4_ninguno
      ,indigenas_f6_4_otroProto
      ,indigenas_f6_4_otroProto_cual

			/*¿La institución cuenta con buenas prácticas que
			 considere sean innovadoras para mejorar el acceso a la justicia a personas indígenas?*/
			 ,indigenas_f6_5_buenprac

			/*¿Cuáles son esas buenas prácticas?*/
			,indigenas_f6_6_cualBuenprac

			/*¿Cuentan con algún tipo de colaboración con otras instituciones u organismos nacionales o extranjeros?*/
			,colaboracion_f9_tipcolins

			/*¿Con qué instituciones u organismos mantienen colaboración?*/
			,colaboracion_f9_1_insorgcol

			/*¿Qué tipo de colaboración mantienen?*/
			,colaboracion_f9_2_finan
      ,colaboracion_f9_2_don
      ,colaboracion_f9_2_capa
      ,colaboracion_f9_2_otros
      ,colaboracion_f9_2_otros_cual

			/*Describir el tipo de colaboración señalada en la pregunta anterior:*/
			,colaboracion_f9_3_descolseñ

			/*¿Cuál es el total de bodegas/almacenes/centros para el resguardo de evidencias que existen en la entidad?*/
			,infraestructura_f10_totbodalcen

			/*¿Cuentan con inventario de la evidencia que se resguarda?*/
			,infraestructura_f10_1_invevires

			/*¿Cuentan con almacenes temporales de bienes asegurados?*/
			,infraestructura_f10_2_almtemase

			/*¿Cuentan con un sistema/plataforma en donde ofrecen servicios de justicia digital para la ciudadanía?*/
			,registro_f11_sisplajus

			/*¿Qué servicios proveen a través de este sistema/plataforma?*/
			,registro_f11_1_serprosispla

			/*Favor de proporcionar el vínculo o liga de acceso:*/
			,registro_f11_2_provinlig

			/*¿La institución cuenta con alguno de los siguientes registros internos de información para el ejercicio de sus funciones?*/
			,registro_f11_3_cap
      ,registro_f11_3_perdet
      ,registro_f11_3_del
      ,registro_f11_3_vic
      ,registro_f11_3_carpinv
      ,registro_f11_3_perdesext
      ,registro_f11_3_denrec
      ,registro_f11_3_perdetmp
      ,registro_f11_3_diliate
      ,registro_f11_3_otros
      ,registro_f11_3_otros_cual

			/*¿Qué formatos de registro de información utiliza la institución?*/
			,registro_f11_4_lobbit
      ,registro_f11_4_bdexc
      ,registro_f11_4_appinf
      ,registro_f11_4_plat
      ,registro_f11_4_capageoinf
      ,registro_f11_4_otros
      ,registro_f11_4_otros_cual

			/*¿El registro interno permite la interconexión y el intercambio de información con alguna otra institución?*/
			,registro_f11_5_regintinf

			/*¿Con cuál o cuáles de los siguientes operadores intercambian información?*/
			,registro_f11_6_instmunseg
      ,registro_f11_6_insmusegpubent
      ,registro_f11_6_instestaent
      ,registro_f11_6_instestaotent
      ,registro_f11_6_secsegprociu
      ,registro_f11_6_guarnac
      ,registro_f11_6_progenjfent
      ,registro_f11_6_progenjfotent
      ,registro_f11_6_fisespent
      ,registro_f11_6_fisgenrep
      ,registro_f11_6_podjudent
      ,registro_f11_6_podjudotent
      ,registro_f11_6_podjudfed
      ,registro_f11_6_sispenent
      ,registro_f11_6_sispenotent
      ,registro_f11_6_sispenfed
      ,registro_f11_6_orgemascent
      ,registro_f11_6_orgemascotent
      ,registro_f11_6_orgemascfed
      ,registro_f11_6_autssmscent
      ,registro_f11_6_autssmscotent
      ,registro_f11_6_autsesmcsfed
      ,registro_f11_6_otros
      ,registro_f11_6_otros_cual

			/*Sin incluir el Modelo de Evaluación y Seguimiento (MES),
			¿La institución cuenta con indicadores para el seguimiento,
			 monitoreo y evaluación del Sistema de Justicia?*/
			 ,evaluacion_f12_modevaseg

			/*¿Cuáles son esos indicadores?*/
			,evaluacion_f12_1_cualind

			/*¿Con qué frecuencia se evalúan dichos indicadores?*/
			,evaluacion_f12_2_frecind

/*         TRANSPARENCIA     */
      ,trasparencia_f13_prac
			,transparencia_f13_bueprac
			,transparencia_f13_noaplica

/*            14 ¿Qué requiere la Fiscalía/Procuraduría para desempeñar correctamente sus funciones?*/

       ,necesidades_f14_cap
			 ,necesidades_f14_recma
			 ,necesidades_f14_rectec
			 ,necesidades_f14_rechum
			 ,necesidades_f14_infra
			 ,necesidades_f14_mejleg
			 ,necesidades_f14_proto
			 ,necesidades_f14_otro
			 ,necesidades_f14_otrocua
			 ,necesidades_f14_noaplica
			 ,necesidades_f14_nosesabe
			 ,necesidades_f14_1_desnece
			 ,necesidades_f14_1_noaplica

/*            RESPONSABILIDADES DE LOS SERVIDORES PÚBLICOS: RESPONSABILIDAD ADMINISTRATIVA*/

        ,responsabilidades_f15_orgesp
				,responsabilidades_f15_totquej

				,respon_f15_1_2_fis_M
				,respon_f15_1_2_fis_H
				,respon_f15_1_2_fis_T

				,respon_f15_1_2_vifis_M
				,respon_f15_1_2_vifis_H
				,respon_f15_1_2_vifis_T

				,respon_f15_1_2_ageminpub_M
				,respon_f15_1_2_ageminpub_H
				,respon_f15_1_2_ageminpub_T

				,respon_f15_1_2_secminpub_M
				,respon_f15_1_2_secminpub_H
				,respon_f15_1_2_secminpub_T

				,respon_f15_1_2_peri_M
				,respon_f15_1_2_peri_H
				,respon_f15_1_2_peri_T

				,respon_f15_1_2_polmin_M
				,respon_f15_1_2_polmin_H
				,respon_f15_1_2_polmin_T

				,respon_f15_1_2_polinv_M
				,respon_f15_1_2_polinv_H
				,respon_f15_1_2_polinv_T

				,respon_f15_1_2_otro
				,respon_f15_1_2_otro_M
				,respon_f15_1_2_otro_H
				,respon_f15_1_2_otro_T

				,respon_f15_1_2_noaplica
				,respon_f15_1_2_nosesabe

				,respon_f15_1_3_fis_M
				,respon_f15_1_3_fis_H
				,respon_f15_1_3_fis_T

				,respon_f15_1_3_vifis_M
				,respon_f15_1_3_vifis_H
				,respon_f15_1_3_vifis_T

				,respon_f15_1_3_ageminpub_M
				,respon_f15_1_3_ageminpub_H
				,respon_f15_1_3_ageminpub_T

				,respon_f15_1_3_secminpub_M
				,respon_f15_1_3_secminpub_H
				,respon_f15_1_3_secminpub_T

				,respon_f15_1_3_peri_M
				,respon_f15_1_3_peri_H
				,respon_f15_1_3_peri_T

				,respon_f15_1_3_polmin_M
				,respon_f15_1_3_polmin_H
				,respon_f15_1_3_polmin_T

				,respon_f15_1_3_polinv_M
				,respon_f15_1_3_polinv_H
				,respon_f15_1_3_polinv_T

				,respon_f15_1_3_otro
				,respon_f15_1_3_otro_M
				,respon_f15_1_3_otro_H
				,respon_f15_1_3_otro_T
				,respon_f15_1_3_noaplica
				,respon_f15_1_3_nosesabe

				,responsabilidades_f15_2_orgesp

				,denservp_f15_2_1_fis_M
				,denservp_f15_2_1_fis_H
				,denservp_f15_2_1_fis_T

				,denservp_f15_2_1_vifis_M
				,denservp_f15_2_1_vifis_H
				,denservp_f15_2_1_vifis_T

				,denservp_f15_2_1_ageminpub_M
				,denservp_f15_2_1_ageminpub_H
				,denservp_f15_2_1_ageminpub_T

				,denservp_f15_2_1_secminpub_M
				,denservp_f15_2_1_secminpub_H
				,denservp_f15_2_1_secminpub_T

				,denservp_f15_2_1_peri_M
				,denservp_f15_2_1_peri_H
				,denservp_f15_2_1_peri_T

				,denservp_f15_2_1_polmin_M
				,denservp_f15_2_1_polmin_H
				,denservp_f15_2_1_polmin_T

				,denservp_f15_2_1_polinv_M
				,denservp_f15_2_1_polinv_H
				,denservp_f15_2_1_polinv_T

				,denservp_f15_2_1_otro
				,denservp_f15_2_1_otro_M
				,denservp_f15_2_1_otro_H
				,denservp_f15_2_1_otro_T
				,denservp_f15_2_1_noaplica
				,denservp_f15_2_1_nosesabe


				,denservp_f15_2_2_fis_M
				,denservp_f15_2_2_fis_H
				,denservp_f15_2_2_fis_T

				,denservp_f15_2_2_vifis_M
				,denservp_f15_2_2_vifis_H
				,denservp_f15_2_2_vifis_T

				,denservp_f15_2_2_ageminpub_M
				,denservp_f15_2_2_ageminpub_H
				,denservp_f15_2_2_ageminpub_T

				,denservp_f15_2_2_secminpub_M
				,denservp_f15_2_2_secminpub_H
				,denservp_f15_2_2_secminpub_T

				,denservp_f15_2_2_peri_M
				,denservp_f15_2_2_peri_H
				,denservp_f15_2_2_peri_T

				,denservp_f15_2_2_polmin_M
				,denservp_f15_2_2_polmin_H
				,denservp_f15_2_2_polmin_T

				,denservp_f15_2_2_polinv_M
				,denservp_f15_2_2_polinv_H
				,denservp_f15_2_2_polinv_T

				,denservp_f15_2_2_otro
				,denservp_f15_2_2_otro_M
				,denservp_f15_2_2_otro_H
				,denservp_f15_2_2_otro_T
				,denservp_f15_2_2_noaplica
				,denservp_f15_2_2_nosesabe

/*       16.Total de denuncias, querellas y otros requisitos equivalentes recibidos en el año 2020.*/
         ...
         ,denuncias_f16_den
				 ...
				 ,denuncias_f16_viofa
				 ,denuncias_f16_absex
				 ,denuncias_f16_hostsex
				 ,denuncias_f16_viola
				 ,denuncias_f16_traper
				 ,denuncias_f16_cormen
				 ,denuncias_f16_trafmen
				 ,denuncias_f16_2_mecnopre
				 ,denuncias_f16_3_pagint
				 ,denuncias_f16_3_tel
				 ,denuncias_f16_3_app
				 ,denuncias_f16_3_sms
				 ,denuncias_f16_3_otro
				 ,denuncias_f16_3_otrocua
				 ,denuncias_f16_4_denopre





			/*Total de carpetas de investigación abiertas en el año 2020, por tipo de sistema:*/
			,carpetas_f17_tot
      ,carpetas_f17_sistrad
      ,carpetas_f17_penacu

			/*Total de imputados en carpetas de investigación abiertas en el año 2020. Desglosar por edad y por sexo.*/
			,carpetas_f17_1_toimp_TM
      ,carpetas_f17_1_toimp_TH
      ,carpetas_f17_1_toimp_TT
      ,carpetas_f17_1_toimp_Men18M
      ,carpetas_f17_1_toimp_Men18H
      ,carpetas_f17_1_toimp_Men18T
      ,carpetas_f17_1_toimp_M
      ,carpetas_f17_1_toimp_H
      ,carpetas_f17_1_toimp_T

			/*Total de imputados en los siguientes delitos en carpetas de investigación abiertas en el año 2020. Desglosar por sexo.*/
			,carpetas_f17_2_hom_M
      ,carpetas_f17_2_hom_H
      ,carpetas_f17_2_hom_T
      ,carpetas_f17_2_fem_M
      ,carpetas_f17_2_fem_H
      ,carpetas_f17_2_fem_T
      ,carpetas_f17_2_les_M
      ,carpetas_f17_2_les_H
      ,carpetas_f17_2_les_T
      ,carpetas_f17_2_viofam_M
      ,carpetas_f17_2_viofam_H
      ,carpetas_f17_2_viofam_T
      ,carpetas_f17_2_abuss_M
      ,carpetas_f17_2_abuss_H
      ,carpetas_f17_2_abuss_T
      ,carpetas_f17_2_hoss_M
      ,carpetas_f17_2_hoss_H
      ,carpetas_f17_2_hoss_T
      ,carpetas_f17_2_vio_M
      ,carpetas_f17_2_vio_H
      ,carpetas_f17_2_vio_T
      ,carpetas_f17_2_tper_M
      ,carpetas_f17_2_tper_H
      ,carpetas_f17_2_tper_T
      ,carpetas_f17_2_comen_M
      ,carpetas_f17_2_comen_H
      ,carpetas_f17_2_comen_T
      ,carpetas_f17_2_trame_M
      ,carpetas_f17_2_trame_H
      ,carpetas_f17_2_trame_T


			/*Total de atenciones brindadas sin contar las carpetas de investigación abiertas en el año 2020:*/
			,carpetas_f17_3_tot
      ,carpetas_f17_3_actcir
      ,carpetas_f17_3_conconsde
      ,carpetas_f17_3_coninddel
      ,carpetas_f17_3_canapp
      ,carpetas_f17_3_canau
      ,carpetas_f17_3_oriase
      ,carpetas_f17_3_otro
      ,carpetas_f17_3_otro_cual

			/*Indicar el total de carpetas de investigación canalizadas a través de una solución alternativa:*/
			,carpetas_f17_4_tot
      ,carpetas_f17_4_susco
      ,carpetas_f17_4_acurep

			/*Indicar el total de personas para las cuales se solicitó una medida cautelar. Desglosar por sexo.*/
			,medida_f18_totmed_M
      ,medida_f18_totmed_H
      ,medida_f18_totmed_T

			/*Indicar el total de personas para las cuales se solicitó una medida cautelar. Desglosar por tipo de medida y sexo.*/
			,medida_f18_1_preper_M
      ,medida_f18_1_preper_H
      ,medida_f18_1_preper_T
      ,medida_f18_1_exhga_M
      ,medida_f18_1_exhga_H
      ,medida_f18_1_exhga_T
      ,medida_f18_1_embbi_M
      ,medida_f18_1_embbi_H
      ,medida_f18_1_embbi_T
      ,medida_f18_1_inmcu_M
      ,medida_f18_1_inmcu_H
      ,medida_f18_1_inmcu_T
      ,medida_f18_1_propais_M
      ,medida_f18_1_propais_H
      ,medida_f18_1_propais_T
      ,medida_f18_1_somciu_M
      ,medida_f18_1_somciu_H
      ,medida_f18_1_somciu_T
      ,medida_f18_1_proconc_M
      ,medida_f18_1_proconc_H
      ,medida_f18_1_proconc_T
      ,medida_f18_1_propersvic_M
      ,medida_f18_1_propersvic_H
      ,medida_f18_1_propersvic_T
      ,medida_f18_1_sepdom_M
      ,medida_f18_1_sepdom_H
      ,medida_f18_1_sepdom_T
      ,medida_f18_1_sustemej_M
      ,medida_f18_1_sustemej_H
      ,medida_f18_1_sustemej_T
      ,medida_f18_1_sustemlab_M
      ,medida_f18_1_sustemlab_H
      ,medida_f18_1_sustemlab_T
      ,medida_f18_1_collocele_M
      ,medida_f18_1_collocele_H
      ,medida_f18_1_collocele_T
      ,medida_f18_1_resdomm_M
      ,medida_f18_1_resdomm_H
      ,medida_f18_1_resdomm_T
      ,medida_f18_1_pripre_M
      ,medida_f18_1_pripre_H
      ,medida_f18_1_pripre_T
      ,medida_f18_1_pripre_otras
      ,medida_f18_1_pripre_M
      ,medida_f18_1_pripre_H
      ,medida_f18_1_pripre_T

			/*¿Cuál es el total de víctimas derivadas
			 de las carpetas de investigación abiertas en el año 2020? Desglosar por sexo y por edad.*/
			 ,victimas_f19_totvic_TM
       ,victimas_f19_totvic_TH
       ,victimas_f19_totvic_TT
       ,victimas_f19_totvic_M
       ,victimas_f19_totvic_H
       ,victimas_f19_totvic_T
       ,victimas_f19_totvic_Men18M
       ,victimas_f19_totvic_Men18H
       ,victimas_f19_totvic_Men18T

			/*¿Cuál fue el total de víctimas derivadas de las causas penales ingresadas durante
			 el año 2020? Desglosar por sexo y por delito.*/
			 ,carpetas_f19_1_hom_M
       ,carpetas_f19_1_hom_H
       ,carpetas_f19_1_hom_T
       ,carpetas_f19_1_fem_M
       ,carpetas_f19_1_fem_H
       ,carpetas_f19_1_fem_T
       ,carpetas_f19_1_les_M
       ,carpetas_f19_1_les_H
       ,carpetas_f19_1_les_T
       ,carpetas_f19_1_viofam_M
       ,carpetas_f19_1_viofam_H
       ,carpetas_f19_1_viofam_T
       ,carpetas_f19_1_abuss_M
       ,carpetas_f19_1_abuss_H
       ,carpetas_f19_1_abuss_T
       ,carpetas_f19_1_hoss_M
       ,carpetas_f19_1_hoss_H
       ,carpetas_f19_1_hoss_T
       ,carpetas_f19_1_vio_M
       ,carpetas_f19_1_vio_H
       ,carpetas_f19_1_vio_T
       ,carpetas_f19_1_tratpe_M
       ,carpetas_f19_1_tratpe_H
       ,carpetas_f19_1_tratpe_T
       ,carpetas_f19_1_corrmen_M
       ,carpetas_f19_1_corrmen_H
       ,carpetas_f19_1_corrmen_T
       ,carpetas_f19_1_trafmen_M
       ,carpetas_f19_1_trafmen_H
       ,carpetas_f19_1_trafmen_T
       ,carpetas_f19_1_nosesabe_T

			/*¿La institución cuenta con buenas prácticas que considere
			 sean innovadoras para evitar la revictimización de víctimas directas o indirectas?*/
			 ,carpetas_f19_2_insprainn

			/*¿Cuáles son esas buenas prácticas?*/
			,carpetas_f19_3_cualBuenprac

			/*¿La institución participa en las Mesas de Justicia -judicialización- de la entidad?*/
			,justicia_f20_insmesajus

			/*¿Qué instituciones participan en las Mesas de Justicia-judicialización-?*/
			,justicia_f20_1_secgobest
      ,justicia_f20_1_uniapsisjus
      ,justicia_f20_1_pretrijuses
      ,justicia_f20_1_fiscagenest
      ,justicia_f20_1_secsegpubpol
      ,justicia_f20_1_titinsdef
      ,justicia_f20_1_subsispeni
      ,justicia_f20_1_autorisup
      ,justicia_f20_1_titularestamu
      ,justicia_f20_1_dif
      ,justicia_f20_1_sip
      ,justicia_f20_1_secrsal
      ,justicia_f20_1_comiejeatenvic
      ,justicia_f20_1_centvichom
      ,justicia_f20_1_titujusmuje
      ,justicia_f20_1_fiscaespdel
      ,justicia_f20_1_direcenpen
      ,justicia_f20_1_centrinter
      ,justicia_f20_1_orgmecalt
      ,justicia_f20_1_servperfor
      ,justicia_f20_1_otros
      ,justicia_f20_1_otros_cuales

			/*¿Con qué frecuencia se realizan las Mesas de Justicia-judicialización- en la entidad?*/
			,justicia_f20_2_semanal
      ,justicia_f20_2_quincenal
      ,justicia_f20_2_mensual
      ,justicia_f20_2_bimes
      ,justicia_f20_2_trimes
      ,justicia_f20_2_semestral
      ,justicia_f20_2_anual

			/*Describir buenas prácticas que considere sean innovadoras para mejorar el Sistema de Justicia y
			 que hayan sido implementadas en la entidad derivadas de las Mesas de Justicia -judicialización-*/
			 ,justicia_f20_3_desbuenprajus

			/*¿La institución incorporó medidas preventivas
			 durante COVID-19 que considere sean innovadoras para
			  proteger la salud del personal que labora?*/
				,justicia_f21_prevecovid

			/*Describir las medidas señaladas en la pregunta anterior:*/
			,justicia_f21_1_medseña

			/*¿La institución incorporó medidas preventivas durante
			COVID-19 que considere sean innovadoras para proteger la salud
			 de las personas usuarias/ciudadanía?*/
			 ,justicia_f21_2_insmedprev

			/*Describir las medidas/buenas prácticas señaladas en la pregunta anterior*/
			,justicia_f21_3_medibueprac

			/*¿La institución cuenta/participa en un programa de Justicia Terapéutica para la atención
			 y/o tratamiento específico del consumo problemático de sustancias psicoactivas de personas imputadas?*/
			 ,justicia_f22_justteaaten

			/*Total de personas imputadas que presuntamente cometieron un delito bajo el efecto de
			alguna/s sustancia/s psicoactiva/s o síndrome de abstinencia. Desglosar por edad y sexo. */
			,justicia_f22_1_delbajo_M
      ,justicia_f22_1_delbajo_H
      ,justicia_f22_1_delbajo_T
      ,justicia_f22_1_delbajo_Men18M
      ,justicia_f22_1_delbajo_Men18H
      ,justicia_f22_1_delbajo_Men18T
      ,justicia_f22_1_delbajo_TM
      ,justicia_f22_1_delbajo_TH
      ,justicia_f22_1_delbajo_TT

			/*Total de personas imputadas que presuntamente cometieron un delito bajo el efecto de alguna/s sustancia/s
			 psicoactiva/s o síndrome de abstinencia. Desglosar por sexo y delito.*/
			 ,justicia_f22_2_delbajo_narco_M
       ,justicia_f22_2_delbajo_narco_H
       ,justicia_f22_2_delbajo_narco_T
       ,justicia_f22_2_delbajo_poses_M
       ,justicia_f22_2_delbajo_poses_H
       ,justicia_f22_2_delbajo_poses_T
       ,justicia_f22_2_delbajo_comer_M
       ,justicia_f22_2_delbajo_comer_H
       ,justicia_f22_2_delbajo_comer_T
       ,justicia_f22_2_delbajo_suminis_M
       ,justicia_f22_2_delbajo_suminis_H
       ,justicia_f22_2_delbajo_suminis_T
       ,justicia_f22_2_delbajo_viofam_M
       ,justicia_f22_2_delbajo_viofam_H
       ,justicia_f22_2_delbajo_viofam_T
       ,justicia_f22_2_delbajo_robsimp_M
       ,justicia_f22_2_delbajo_robsimp_H
       ,justicia_f22_2_delbajo_robsimp_T
       ,justicia_f22_2_delbajo_dalmatpat_M
       ,justicia_f22_2_delbajo_dalmatpat_H
       ,justicia_f22_2_delbajo_dalmatpat_T
       ,justicia_f22_2_delbajo_lesiones_M
       ,justicia_f22_2_delbajo_lesiones_H
       ,justicia_f22_2_delbajo_lesiones_T
       ,justicia_f22_2_delbajo_atenpudor_M
       ,justicia_f22_2_delbajo_atenpudor_H
       ,justicia_f22_2_delbajo_atenpudor_T
       ,justicia_f22_2_delbajo_otros
       ,justicia_f22_2_delbajo_otros_M
       ,justicia_f22_2_delbajo_otros_H
       ,justicia_f22_2_delbajo_otros_T

			/*Total de personas imputadas que presuntamente cometieron un delito bajo el efecto de alguna/s sustancia/s psicoactiva/s. Desglosar por sexo y por sustancia utilizada.*/
			,justicia_f22_3_persodess_cann_M
      ,justicia_f22_3_persodess_cann_H
      ,justicia_f22_3_persodess_cann_T
      ,justicia_f22_3_persodess_metan_M
      ,justicia_f22_3_persodess_metan_H
      ,justicia_f22_3_persodess_metan_T
      ,justicia_f22_3_persodess_fenta_M
      ,justicia_f22_3_persodess_fenta_H
      ,justicia_f22_3_persodess_fenta_T
      ,justicia_f22_3_persodess_coca_M
      ,justicia_f22_3_persodess_coca_H
      ,justicia_f22_3_persodess_coca_T
      ,justicia_f22_3_persodess_hero_M
      ,justicia_f22_3_persodess_hero_H
      ,justicia_f22_3_persodess_hero_T
      ,justicia_f22_3_persodess_alco_M
      ,justicia_f22_3_persodess_alco_H
      ,justicia_f22_3_persodess_alco_T
      ,justicia_f22_3_persodess_otros
      ,justicia_f22_3_persodess_otros_M
      ,justicia_f22_3_persodess_otros_H
      ,justicia_f22_3_persodess_otros_T

			/*Total de personas imputadas a las que se les supervisan medidas cautelares y fueron remitidas a algún programa de atención y/o tratamiento específico para atender el consumo problemático de sustancias psicoactivas.*/
			,justicia_f22_4_perinmcau_M
      ,justicia_f22_4_perinmcau_H
      ,justicia_f22_4_perinmcau_T
      ,justicia_f22_4_perinmcau_Men18M
      ,justicia_f22_4_perinmcau_Men18H
      ,justicia_f22_4_perinmcau_Men18T
      ,justicia_f22_4_perinmcau_TM
      ,justicia_f22_4_perinmcau_TH
      ,justicia_f22_4_perinmcau_TT

			/*Total de personas imputadas que se encuentran en un programa de Justicia Terapéutica cuyos casos fueron resueltos por acuerdo reparatorio. Desglosar por estatus y sexo. */
			,justicia_f22_5_persinpjus_TM
      ,justicia_f22_5_persinpjus_TH
      ,justicia_f22_5_persinpjus_TT
      ,justicia_f22_5_persinpjus_RM
      ,justicia_f22_5_persinpjus_RH
      ,justicia_f22_5_persinpjus_RT
      ,justicia_f22_5_persinpjus_ENM
      ,justicia_f22_5_persinpjus_ENH
      ,justicia_f22_5_persinpjus_ENT

			/*¿Cuentan con fiscalías especializadas en la investigación y atención de delitos de violencia contra la mujer?*/
			,fespecializadas_f23_fisespmu

			/*En caso de no contar con una fiscalía especializada, registrar el total de personal especializado en justicia para mujeres en la Fiscalía/Procuraduría General del Estado. Desglosar por sexo.*/
			,fespecializadas_f23_1_M
      ,fespecializadas_f23_1_H
      ,fespecializadas_f23_1_T

			/*En caso de no contar con una fiscalía especializada ¿qué acciones se están implementando para la atención de víctimas y la investigación de delitos con perspectiva de género?*/
			,fespecializadas_f23_2_nocuefis

			/*¿Cuál es el total de fiscalías especializadas en la investigación y atención de delitos de violencia contra la mujer con las que cuenta la entidad?*/
			,fespecializadas_f23_3_totfisdelvm

			/*Indique el nombre de cada una de las  fiscalías especializadas reportadas en la pregunta anterior.*/
			,fespecializadas_f23_3_1_nomfis

			/*¿Las fiscalías especializadas cuentan con autonomía de gestión?*/
			,fespecializadas_f23_4_fisespges

			/*Indicar la siguiente información de únicamente de las fiscalías especializadas en delitos de violencia contra la mujer en la entidad.*/
			,fespecializadas_f23_5_nomfis
      ,fespecializadas_f23_5_munalc
      ,fespecializadas_f23_5_calle
      ,fespecializadas_f23_5_num
      ,fespecializadas_f23_5_col
      ,fespecializadas_f23_5_cp
      ,fespecializadas_f23_5_refdi
      ,fespecializadas_f23_5_corcon
      ,fespecializadas_f23_5_tel
      ,fespecializadas_f23_5_nomtit
      ,fespecializadas_f23_5_hate
	...
	static public function mdlEditarFFiscalesTab1($tabla, $datos){
	...
	static public function mdlEditarFPoliciaTab3($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET
				mujeres_f4_protoInter = :mujeres_f4_protoInter
			, mujeres_f4_protoInter_cual = :mujeres_f4_protoInter_cual
			, mujeres_f4_interno = :mujeres_f4_interno
			, mujeres_f4_interno_cua = :mujeres_f4_interno_cua
			, mujeres_f4_protoInvmpp = :mujeres_f4_protoInvmpp
			, mujeres_f4_protoscjnjpg = :mujeres_f4_protoscjnjpg
			, mujeres_f4_ninguno = :mujeres_f4_ninguno
      , mujeres_f4_otroProto = :mujeres_f4_otroProto
      , mujeres_f4_otroProto_cual = :mujeres_f4_otroProto_cual

			, mujeres_f4_1_buenprac = :mujeres_f4_1_buenprac

			, mujeres_f4_2_cualBuenprac = :mujeres_f4_2_cualBuenprac

			, mujeres_f4_3_justmuj_M = :mujeres_f4_3_justmuj_M
			, mujeres_f4_3_justmuj_H = :mujeres_f4_3_justmuj_H
			, mujeres_f4_3_justmuj_T = :mujeres_f4_3_justmuj_T

			, mujeres_f4_4_percapjusmuj = :mujeres_f4_4_percapjusmuj

			, ja_f5_protoInter = :ja_f5_protoInter
			, ja_f5_protoInter_cual = :ja_f5_protoInter_cual
			, ja_f5_interno = :ja_f5_interno
			, ja_f5_interno_cua = :ja_f5_interno_cua
			, ja_f5_protoAtennavicdel = :ja_f5_protoAtennavicdel
			, ja_f5_delconvul = :ja_f5_delconvul
			, ja_f5_ninguno = :ja_f5_ninguno
			, ja_f5_otroProto = :ja_f5_otroProto
			, ja_f5_otroProto_cual = :ja_f5_otroProto_cual

			, ja_f5_1_buenprac = :ja_f5_1_buenprac

			, ja_f5_2_cualBuenprac = :ja_f5_2_cualBuenprac

			, ja_f5_3_fisagemundir = :ja_f5_3_fisagemundir

			, ja_f5_4_fisagemundir = :ja_f5_4_fisagemundir

			, ja_f5_5_totperfisgen_M = :ja_f5_5_totperfisgen_M
			, ja_f5_5_totperfisgen_H = :ja_f5_5_totperfisgen_H
			, ja_f5_5_totperfisgen_T = :ja_f5_5_totperfisgen_T

			, indigenas_f6_inttrleind = :indigenas_f6_inttrleind

			, indigenas_f6_1_nahuatl_M = :indigenas_f6_1_nahuatl_M
			, indigenas_f6_1_nahuatl_H = :indigenas_f6_1_nahuatl_H
			, indigenas_f6_1_nahuatl_T = :indigenas_f6_1_nahuatl_T
			, indigenas_f6_1_Maya_M = :indigenas_f6_1_Maya_M
			, indigenas_f6_1_Maya_H = :indigenas_f6_1_Maya_H
			, indigenas_f6_1_Maya_T = :indigenas_f6_1_Maya_T
			, indigenas_f6_1_Tseltal_M = :indigenas_f6_1_Tseltal_M
			, indigenas_f6_1_Tseltal_H = :indigenas_f6_1_Tseltal_H
			, indigenas_f6_1_Tseltal_T = :indigenas_f6_1_Tseltal_T
			, indigenas_f6_1_Mixteco_M = :indigenas_f6_1_Mixteco_M
			, indigenas_f6_1_Mixteco_H = :indigenas_f6_1_Mixteco_H
			, indigenas_f6_1_Mixteco_T = :indigenas_f6_1_Mixteco_T
			, indigenas_f6_1_Tsotsil_M = :indigenas_f6_1_Tsotsil_M
			, indigenas_f6_1_Tsotsil_H = :indigenas_f6_1_Tsotsil_H
			, indigenas_f6_1_Tsotsil_T = :indigenas_f6_1_Tsotsil_T
			, indigenas_f6_1_otro = :indigenas_f6_1_otro
			, indigenas_f6_1_otro_M = :indigenas_f6_1_otro_M
			, indigenas_f6_1_otro_H = :indigenas_f6_1_otro_H
			, indigenas_f6_1_otro_T = :indigenas_f6_1_otro_T

			, indigenas_f6_2_coninsser = :indigenas_f6_2_coninsser

			, indigenas_f6_3_nomins = :indigenas_f6_3_nomins

			, indigenas_f6_4_protoInter = :indigenas_f6_4_protoInter
			, indigenas_f6_4_protoInter_cual = :indigenas_f6_4_protoInter_cual
			, indigenas_f6_4_interno = :indigenas_f6_4_interno
			, indigenas_f6_4_interno_cua = :indigenas_f6_4_interno_cua
			, indigenas_f6_4_scjn = :indigenas_f6_4_scjn
			, indigenas_f6_4_ninguno = :indigenas_f6_4_ninguno
			, indigenas_f6_4_otroProto = :indigenas_f6_4_otroProto
			, indigenas_f6_4_otroProto_cual = :indigenas_f6_4_otroProto_cual

			, indigenas_f6_5_buenprac = :indigenas_f6_5_buenprac

			, indigenas_f6_6_cualBuenprac = :indigenas_f6_6_cualBuenprac
			...
			$stmt -> bindParam(":idFormulario", $datos["idFormulario"], PDO::PARAM_STR);
			$stmt -> bindParam(":mujeres_f4_protoInter", $datos["mujeres_f4_protoInter"], PDO::PARAM_STR);
			...
			$stmt -> bindParam(":nna_p5_1_buenprac", $datos["nna_p5_1_buenprac"], PDO::PARAM_STR);
