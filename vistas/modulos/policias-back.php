        ...
        <div class="box">
            <header class="text-center">
              ...
              <a title="PDF" href="extensiones/tcpdf/pdf/pdfPolicias.php?id=<?php echo $_SESSION["id"]; ?>
                ...
                <br><br>
<div style="float:right; padding-right:15px">Estatus del formulario:


<?php
if ($estatus = 0) {
  echo '<td><button class="btn btn-warning btn-xs btnActivar" estatus="'.$value["estatus"].'">En llenado</button></td>';
} elseif ($estatus = 1) {
  echo '<td><button class="btn btn-warning btn-xs btnActivar" estatus="'.$value["estatus"].'" >En revicion</button></td>';
} else {
  echo '<td><button class="btn btn-warning btn-xs btnActivar" estatus="'.$value["estatus"].'" >Finalizado</button></td>';
}
?>
...
?>
                                            ...
                                            Nombre de la persona responsable del cuestionario:
                                          ...
                                          Cargo:<input type="text" name="cargo" id="cargo"
                                            ...
                                            Área o unidad de adscripción: <input type="text" name="area"
                                                id="area" class="form-control" value="<?php echo $area; ?>">
                                          Correo electrónico:<input type="text" name="mail" id="mail"
                                                class="form-control" value="<?php echo $mail; ?>">
                                            Teléfono de oficina:<input type="text" name="telofi"
                                                id="telofi" class="form-control" value="<?php echo $telofi; ?>">
                                           Extensión: <input type="text" name="ext" id="ext"
                                                class="form-control" value="<?php echo $ext; ?>">
                                            Otro teléfono: <input type="text" name="telextra"
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        Nombre de la persona responsable del cuestionario: <input type="text"
                                            name="pcontacto2" id="pcontacto2" class="form-control"
                                            value="<?php echo $pcontacto2; ?>">
                                        Cargo: <input type="text" name="cargo2" id="cargo2" class="form-control"
                                            value="<?php echo $cargo2; ?>">
                                        Área o unidad de adscripción: <input type="text" name="area2" id="area2"
                                            class="form-control" value="<?php echo $area2; ?>">
                                        Correo electrónico: <input type="text" name="mail2" id="mail2"
                                            class="form-control" value="<?php echo $mail2; ?>">
                                        Teléfono de oficina: <input type="text" name="telofi2" id="telofi2"
                                            class="form-control" value="<?php echo $telofi2; ?>">
                                        Extensión: <input type="text" name="ext2" id="ext2" class="form-control"
                                            value="<?php echo $ext2; ?>">
                                        Otro teléfono: <input type="text" name="telextra2" id="telextra2"
...
<!--  Pregunta 1  -->
  ...
  <th>#</th>
      ...
      <td>8</td>
                                            ...
                                            <div>
                                                <h5>1.2.-
                                                    Del personal reportado en las categorías 1 a 7 de la pregunta anterior,
                                                     ¿Cuántas personas laboran en la institución? Desglosar por ingreso bruto mensual y por sexo.
                                                </h5>
                                            </div>
                                            <br>
                                            <table class="table">
                                                                                                                ...
                                                                                                                <div class="form-group col-md-6">
                                                                                                                    <div class="form-check form-check-inline">
                                                                                                                        <input class="form-check-input" type="radio"
                                                                                                                            ...
                                                                                                                            <?php if ($capacitacion_p2 == "Si"){echo ' checked="checked"'; }?> />
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="capacitacion_p2_1_nom" id="capacitacion_p2_1_nom" rows="10" cols="90" ><?php echo $capacitacion_p2_1_nom; ?></textarea>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_aul ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_comp ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_juor ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_come ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_coci ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_dorm ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_pruf ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_auvis ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_medi ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_tirof ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_tirov ?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo $capacitacion_p2_2_otro ?> />
                                                                ...
                                                                <div id="content04" style="display: none;">
                                                                    ...
                                                                    <input class="form-control" type="text" name="capacitacion_p2_2_otro_cual"
                                                                        ...
                                                                        <?php echo $capacitacion_p2_2_otro_cual; ?> />
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="capacitacion_p2_5_instuprga" id="capacitacion_p2_5_instuprga" rows="10" cols="90" ><?php echo $capacitacion_p2_5_instuprga; ?></textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    <?php if ($presupuesto_p3 == "checked"){echo ' checked="checked"'; }?> />
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="presupuesto_p3" id="presupuesto_p3"
                                                                    <?php if ($presupuesto_p3 == "unchecked"){echo ' checked="checked"'; }?> />
                                                                <label class="form-check-label"
...
?>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input group1" type="checkbox"
                                                                name="mujeres_p4_protoInterna"
                                                                id="mujeres_p4_protoInterna"
                                                                onchange="javascript:showContent()"
                                                                <?php echo $mujeres_p4_protoInterna ?> />
                                                            <label class="form-check-label"
                                                                for="capacitacion_p2_2_comp">Protocolo internacional
                                                            </label>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                        <label>  <input class="form-check-input group1" type="checkbox"
                                                                name="mujeres_p4_protoInvmipp" id="mujeres_p4_protoInvmipp"
                                                                  <?php echo $mujeres_p4_protoInvmipp; ?> />
                                                            Protocolo de
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <label>    <input class="form-check-input group1" type="checkbox"
                                                              ...
                                                              <?php echo $mujeres_p4_protoScjn; ?> />
                                                            Protocolo de
                                                            la Suprema Corte de Justicia de la Nación para Juzgar
                                                            con Perspectiva de Género</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="mujeres_p4_ninguno" id="mujeres_p4_ninguno"
                                                                <?php echo $mujeres_p4_ninguno; ?> />
                                                            <label class="form-check-label"
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                onchange="javascript:showContent4()"
                                                                <?php echo $mujeres_p4_otroProtocolo ?> />
                                                            <label class="form-check-label" for="mujeresp4">
                                                                Otro</label>
                                                            <br>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  ...
                                                                  <?php if ($mujeres_p4_1_buenprac == "checked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                                  for="presupuestop3">Sí</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  name="mujeres_p4_1_buenprac" id="mujeres_p4_1_buenprac"
                                                                  <?php if ($mujeres_p4_1_buenprac == "unchecked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                                  for="presupuestop3">No</label>
                                                          </div>
                                                      </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea  class="form-control" name="mujeres_p4_2_cualBuenprac"
                                            ...
                                            <!--  Pregunta mujeresp4_2-->
                                            <div>
                                                <h5>4.3.- Total de personal especializado en justicia para mujeres.
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  name="nna_p5_1_buenprac" id="nna_p5_1_buenprac"
                                                                  <?php if ($nna_p5_1_buenprac == "checked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                                  for="presupuestop3">Sí</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  name="nna_p5_1_buenprac" id="nna_p5_1_buenprac"
                                                                  <?php if ($nna_p5_1_buenprac == "unchecked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                                  for="presupuestop3">No</label>
                                                          </div>
                                                      </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="nna_p5_2_cualBuenpract" id="nna_p5_2_cualBuenpract" rows="10" cols="90" ><?php echo $nna_p5_2_cualBuenpract; ?></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <form action="#" method="post" class="col-lg-12">
                                            ...
                                            <div>
                                                <h5>6.- ¿Cuentan con intérpretes/traductores de lenguas indígenas? </h5>
                                            </div>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    <?php if ($indigenas_p6_tradulenind == "checked"){echo ' checked="checked"'; }?> />
                                                                <label class="form-check-label"
                                                                    for="presupuestop3">Sí</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="indigenas_p6_tradulenind" id="indigenas_p6_tradulenind"
                                                                    <?php if ($indigenas_p6_tradulenind == "unchecked"){echo ' checked="checked"'; }?> />
                                                                <label class="form-check-label"
                                                                    for="presupuestop3">No</label>
                                                            </div>
                                                        </div>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  ...
                                                                  <?php if ($indigenas_p6_2_convenio == "checked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  name="indigenas_p6_2_convenio" id="indigenas_p6_2_convenio"
                                                                  <?php if ($indigenas_p6_2_convenio == "unchecked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="indigenas_p6_2_nombinst" id="indigenas_p6_2_nombinst" rows="10" cols="90" ><?php echo $indigenas_p6_2_nombinst; ?></textarea>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                          <input class="form-check-input group64" type="checkbox"
                                                              ...
                                                              <?php echo $indigenas_p6_4_ProtoInter ?> />
                                                          <label class="form-check-label"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                          <input class="form-check-input group64" type="checkbox"
                                                              ...
                                                              <?php echo $indigenas_p6_4_interno ?> />
                                                          <label class="form-check-label"
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <div id="content102" style="display: none;">
                                                                <label class="form-check-label" for="indigenas_p6_4_otro_cual">
                                                                    (¿Cuáles?) </label>
                                                                <input class="form-control" type="text" name="indigenas_p6_4_otro_cual"
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  ...
                                                                  <?php if ($indigenas_p6_5_buenaspract == "checked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  name="indigenas_p6_5_buenaspract" id="indigenas_p6_5_buenaspract"
                                                                  <?php if ($indigenas_p6_5_buenaspract == "unchecked"){echo ' checked="checked"'; }?> />
                                                              <label class="form-check-label"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="indigenas_p6_6_cualbuenaspra" id="indigenas_p6_6_cualbuenaspra" rows="10" cols="90" ><?php echo $indigenas_p6_6_cualbuenaspra; ?></textarea>
...
?>
                                            ...
                                            <div>
                                                <h5>7.- ¿Cuentan con traductores de lenguas extranjeras? </h5>
                                            </div>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
              ...
              <div class="form-group col-md-6">
                  <div class="form-check form-check-inline">
                    ...
                    <?php if ($extranjeras_p7_tradLenExt == "checked"){echo ' checked="checked"'; }?> />
                      <label class="form-check-label"
                      for="extranjeras_p7_tradLenExt">Sí</label>
                      <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio"
                          name="extranjeras_p7_tradLenExt" id="extranjeras_p7_tradLenExt"
                          <?php if ($extranjeras_p7_tradLenExt == "unchecked"){echo ' checked="checked"'; }?> />
                          <label class="form-check-label"
                          for="extranjeras_p7_tradLenExt">No</label>
                                            ...
                                            <!--Fin pregunta extranjeras_p7_-->

                                            <!--  Pregunta extranjeras_p7__1-->
                                            <div>
                                            ...
                                            <div>
                                                <h5>7.2.- ¿Tienen convenios con otra institución que provea este
                                                    servicio?</h5>
                                            </div>
                                            <table class="table">
                                                <tbody>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                        <div class="form-check form-check-inline">
                                                                                                                    <input class="form-check-input" type="radio"
                                                                                                                        ...
                                                                                                                        <?php if ($extranjeras_p7_2_ConvInst == "checked"){echo ' checked="checked"'; }?> />
                                                                                                                    <label class="form-check-label"
                                                                                                                ...
                                                                                                                <div class="form-check form-check-inline">
                                                                                                                    <input class="form-check-input" type="radio"
                                                                                                                        name="extranjeras_p7_2_ConvInst" id="extranjeras_p7_2_ConvInst"
                                                                                                                        <?php if ($extranjeras_p7_2_ConvInst == "unchecked"){echo ' checked="checked"'; }?> />
                                                                                                                    <label class="form-check-label"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="extranjeras_p7_3_nombreInsti" id="extranjeras_p7_3_nombreInsti" rows="10" cols="90" ><?php echo $extranjeras_p7_3_nombreInsti; ?></textarea>
                                                    ...
                                                    <tr>
                                                      <div class="form-check form-check-inline">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                          ...
                                                          <?php echo $extranjeras_p7_4_interno ?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="extranjeras_p7_4_ninguno" id="extranjeras_p7_4_ninguno"
                                                                <?php echo $extranjeras_p7_4_ninguno ?> />
                                                            <label class="form-check-label"
                                                                for="extranjeras_p7_4_ninguno">Ninguno</label>
                                                        </div>

                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input group74" type="checkbox" name="extranjeras_p7_4_Otro"
                                                                id="extranjeras_p7_4_Otro" onchange="javascript:showContent104()"
                                                                <?php echo $extranjeras_p7_4_Otro ?> />
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($extranjeras_p7_5_buenasprac == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      ...
                                                      <input class="form-check-input" type="radio"
                                                      name="extranjeras_p7_5_buenasprac" id="extranjeras_p7_5_buenasprac"
                                                      <?php if ($extranjeras_p7_5_buenasprac == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="extranjeras_p7_6_buenasprac_cual" id="extranjeras_p7_6_buenasprac_cual" rows="10" cols="90" ><?php echo $extranjeras_p7_6_buenasprac_cual; ?></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <form action="#" method="post" class="col-lg-12">
                                            ...
                                            <div>
                                                <h5>8.- ¿Tienen convenios con instituciones u organizaciones de la
                                                    sociedad civil que les proporcionen alguno de estos servicios para
                                                    personas con discapacidad?</h5>
                                            </div>
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($discapacidad_p8_braile == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      ...
                                                      <input class="form-check-input" type="radio"
                                                      name="discapacidad_p8_braile" id="discapacidad_p8_braile"
                                                      <?php if ($discapacidad_p8_braile == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                                                                            ...
                                                                                                            <?php if ($discapacidad_p8_LenSen == "checked"){echo ' checked="checked"'; }?> />
                                                                                                            <label class="form-check-label"
                                                                                                            ...
                                                                                                            <?php if ($discapacidad_p8_LenSen == "unchecked"){echo ' checked="checked"'; }?> />
                                                                                                            <label class="form-check-label"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="discapacidad_p8_1_nombreInst" id="discapacidad_p8_1_nombreInst" rows="10" cols="90" ><?php echo $discapacidad_p8_1_nombreInst; ?></textarea>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                          ...
                                                          <?php echo $discapacidad_p8_2_ProtoInterna ?> />
                                                          <label class="form-check-label"
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                          ...
                                                          <?php echo $discapacidad_p8_2_interno ?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input group82" type="checkbox"
                                                                ...
                                                                <?php echo $discapacidad_p8_2_ProtoImpJust ?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $discapacidad_p8_2_ninguno ?> />

                                                            <label class="form-check-label"
                                                                for="discapacidad_p8_2_ninguno">Ninguno</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="discapacidad_p8_2_otros"
                                                                id="discapacidad_p8_2_otros" onchange="javascript:showContent107()"
                                                                <?php echo $discapacidad_p8_2_otros ?> />
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($discapacidad_p8_3_buenasprac == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      ...
                                                      <input class="form-check-input" type="radio"
                                                      name="discapacidad_p8_3_buenasprac" id="discapacidad_p8_3_buenasprac"
                                                      <?php if ($discapacidad_p8_3_buenasprac == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea class="form-control" name="discapacidad_p8_3_buenasprac_cual" id="discapacidad_p8_3_buenasprac_cual" rows="10" cols="90" ><?php echo $discapacidad_p8_3_buenasprac_cual; ?></textarea>
...
?>
                                            <div>
                                                <h5>9.- ¿Cuentan con algún tipo de colaboración con otras instituciones
                                                    u organismos nacionales o extranjeros? </h5>
                                            </div>
                                            <br>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($colaboracion_p9_tipcol == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      ...
                                                      <input class="form-check-input" type="radio"
                                                      name="colaboracion_p9_tipcol" id="colaboracion_p9_tipcol"
                                                      <?php if ($colaboracion_p9_tipcol == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea class="form-control" name="colaboracion_p9_1_instcol" id="colaboracion_p9_1_instcol" rows="10" cols="90" ><?php echo $colaboracion_p9_1_instcol; ?></textarea>
                                                    ...
                                                    <tr>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $colaboracion_p9_2_finan ?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $colaboracion_p9_2_dona ?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $colaboracion_p9_2_capa ?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <?php echo $colaboracion_p9_2_otros ?> />
                                                            <label class="form-check-label"
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <form action="#" method="post" class="col-lg-12">
                                            <div>
                                                <h5>10.- El personal realiza el llenado del Informe Policial Homologado
                                                    por medio de: </h5>
                                            </div>
                                            <br>
                                            <table class="table">
                                                    ...
                                                    <tr>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $registro_p10_lib ?> />

                                                            <label class="form-check-label" for="registro_p10_lib">
                                                                Libro o bitácora en papel
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_imp"
                                                                <?php echo $registro_p10_imp ?> />

                                                            <label class="form-check-label" for="registro_p10_imp">
                                                                Formato impreso
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_tab"
                                                                <?php echo $registro_p10_tab ?> />

                                                            <label class="form-check-label" for="registro_p10_tab">
                                                                Tableta
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_cel"
                                                                <?php echo $registro_p10_cel ?> />

                                                            <label class="form-check-label" for="registro_p10_cel">
                                                                Celular
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_comp"
                                                                <?php echo $registro_p10_comp ?> />

                                                            <label class="form-check-label" for="registro_p10_comp">
                                                                Computadora
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input group82" type="checkbox"
                                                            name="registro_p10_otro"
                                                            id="registro_p10_otro"
                                                            onchange="javascript:showContent10()"
                                                            <?php echo $registro_p10_otro ?> />
                                                            <label class="form-check-label"
                                                            for="registro_p10_otro">Otro
                                                          </label>

                                                          <div id="content10" style="display: none;">
                                                            <label class="form-check-label"
                                                            for="registro_p10_cual">
                                                            ¿Cuáles?</label>
                                                            <input class="form-control" type="text"
                                                            name="registro_p10_cual"
                                                            id="registro_p10_cual"
                                                            value="<?php echo $registro_p10_cual; ?>"/>
                                                          </div>
                                                          </div>
                                            ...
                                            <div>
                                                ...
                                                <h5>10.1.- ¿La institución cuenta con alguno de los siguientes registros
                                                    internos de información para el ejercicio de sus funciones? </h5>
                                            </div>
                                            <br>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_ind"
                                                                <?php echo $registro_p10_1_ind ?> />

                                                            <label class="form-check-label" for="registro_p10_1_ind">
                                                                Registro individualizado del personal destinado a
                                                                funciones de procuración de justicia
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_per"
                                                                <?php echo $registro_p10_1_per ?> />

                                                            <label class="form-check-label" for="registro_p10_1_per">
                                                                Registro de personal dado de baja
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_cap"
                                                                <?php echo $registro_p10_1_cap ?> />

                                                            <label class="form-check-label" for="registro_p10_1_cap">
                                                                Registro de capacitación y/o evaluación del personal
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_perdet"
                                                                <?php echo $registro_p10_1_perdet ?> />

                                                            <label class="form-check-label" for="registro_p10_1_perdet">
                                                                Registro de personas detenidas
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_del"
                                                                <?php echo $registro_p10_1_del ?> />

                                                            <label class="form-check-label" for="registro_p10_1_del">
                                                                Registro de delitos
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_vic"
                                                                <?php echo $registro_p10_1_vic ?> />

                                                            <label class="form-check-label" for="registro_p10_1_vic">
                                                                Registro de víctimas
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value=""
                                                                id="registro_p10_1_perdes"
                                                                <?php echo $registro_p10_1_perdes ?> />

                                                            <label class="form-check-label" for="registro_p10_1_perdes">
                                                                Registro de personas desaparecidas y/o extraviadas
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_den"
                                                                <?php echo $registro_p10_1_den ?> />

                                                            <label class="form-check-label" for="registro_p10_1_den">
                                                                Denuncias recibidas
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_pedetfad"
                                                                <?php echo $registro_p10_1_pedetfad ?> />

                                                            <label class="form-check-label" for="registro_p10_1_pedetfad">
                                                                Personas detenidas por falta administrativa
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_pedetpdis"
                                                                <?php echo $registro_p10_1_pedetpdis ?> />

                                                            <label class="form-check-label"
                                                                for="registro_p10_1_pedetpdis">
                                                                Personas detenidas y puestas a disposición del MP
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_llam"
                                                                <?php echo $registro_p10_1_llam ?> />

                                                            <label class="form-check-label" for="registro_p10_1_llam">
                                                                Llamadas de emergencia C4 atendidas
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_dil"
                                                                <?php echo $registro_p10_1_dil ?> />

                                                            <label class="form-check-label" for="registro_p10_1_dil">
                                                                Diligencias atendidas
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_part"
                                                                <?php echo $registro_p10_1_part ?> />

                                                            <label class="form-check-label" for="registro_p10_1_part">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_atn"
                                                                <?php echo $registro_p10_1_atn ?> />

                                                            <label class="form-check-label" for="registro_p10_1_atn">
                                                                Atenciones de servicio social brindadas
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_1_actu"
                                                                <?php echo $registro_p10_1_actu ?> />

                                                            <label class="form-check-label" for="registro_p10_1_actu">
                                                                Otras actuaciones realizadas en calidad de Primer
                                                                Respondiente
                                                            </label>
                                                        </div>
                                                                                                                ...
                                                                                                                <div class="form-check form-check-inline">
                                                                                                                    <input class="form-check-input group82" type="checkbox"
                                                                                                                    name="registro_p10_1_otros"
                                                                                                                    id="registro_p10_1_otros"
                                                                                                                    onchange="javascript:showContent1001()"
                                                                                                                    <?php echo $registro_p10_1_otros ?> />
                                                                                                                    <label class="form-check-label"
                                                                                                                    for="registro_p10_1_otros">Otro
                                                                                                                  </label>

                                                                                                                  <div id="content1001" style="display: none;">
                                                                                                                    <label class="form-check-label"
                                                                                                                    for="registro_p10_1_cuales">
                                                                                                                    ¿Cuáles?</label>
                                                                                                                    <input class="form-control" type="text"
                                                                                                                    name="registro_p10_1_cuales"
                                                                                                                    id="registro_p10_1_cuales"
                                                                                                                    value="<?php echo $registro_p10_1_cuales; ?>"/>
                                                                                                                  </div>
                                                                                                                  </div>
                                            ...
                                            <div>
                                                <h5>10.2.- ¿Qué formatos de registro de información utiliza la
                                                    institución? </h5>
                                            </div>
                                            <br>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_2_lib"
                                                                <?php echo $registro_p10_2_lib ?> />

                                                            <label class="form-check-label" for="registro_p10_2_lib">
                                                                Libro o bitácora en papel
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_2_bd"
                                                                <?php echo $registro_p10_2_bd ?> />

                                                            <label class="form-check-label" for="registro_p10_2_bd">
                                                                Base de datos en excel u otra hoja de cálculo
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_2_ap"
                                                                <?php echo $registro_p10_2_ap ?> />

                                                            <label class="form-check-label" for="registro_p10_2_ap">
                                                                Aplicación informática
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_2_plat"
                                                                <?php echo $registro_p10_2_plat ?> />

                                                            <label class="form-check-label" for="registro_p10_2_plat">
                                                                Plataforma
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_2_cap"
                                                                <?php echo $registro_p10_2_cap ?> />

                                                            <label class="form-check-label" for="registro_p10_2_cap">
                                                                Capacidades de georreferenciar información
                                                            </label>
                                                        </div>
                                                                                                                                                                        ...
                                                                                                                                                                        <div class="form-check form-check-inline">
                                                                                                                                                                            <input class="form-check-input group82" type="checkbox"
                                                                                                                                                                            name="registro_p10_2_otro"
                                                                                                                                                                            id="registro_p10_2_otro"
                                                                                                                                                                            onchange="javascript:showContent1002()"
                                                                                                                                                                            <?php echo $registro_p10_2_otro ?> />
                                                                                                                                                                            <label class="form-check-label"
                                                                                                                                                                            for="registro_p10_2_otro">Otro
                                                                                                                                                                          </label>

                                                                                                                                                                          <div id="content1002" style="display: none;">
                                                                                                                                                                            <label class="form-check-label"
                                                                                                                                                                            for="registro_p10_2_cual">
                                                                                                                                                                            ¿Cuáles?</label>
                                                                                                                                                                            <input class="form-control" type="text"
                                                                                                                                                                            name="registro_p10_2_cual"
                                                                                                                                                                            id="registro_p10_2_cual"
                                                                                                                                                                            value="<?php echo $registro_p10_2_cual; ?>"/>
                                                                                                                                                                          </div>
                                                                                                                                                                          </div>
                                            ...
                                            <div>
                                                <h5>10.3.- ¿El registro interno permite la interconexión y el
                                                    intercambio de información con alguna otra institución? </h5>
                                            </div>
                                            <br>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                      <input class="form-check-input" type="radio"
                                                      name="registro_p10_3_inter" id="registro_p10_3_inter"
                                                      <?php if ($registro_p10_3_inter == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      for="registro_p10_3_inter">Sí</label>
                                                      </div>
                                                      <div class="form-check form-check-inline">
                                                      <input class="form-check-input" type="radio"
                                                      name="registro_p10_3_inter" id="registro_p10_3_inter"
                                                      <?php if ($registro_p10_3_inter == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      for="registro_p10_3_inter">No</label>
                                                      </div>
                                                      </div>
                                            ...
                                            <div>
                                                <h5>10.4.- ¿Con cuál o cuáles de las siguientes instituciones
                                                    intercambian información? </h5>
                                            </div>
                                            <br>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_instmun"
                                                                <?php echo $registro_p10_4_instmun ?> />

                                                            <label class="form-check-label" for="registro_p10_4_instmun">
                                                                Instituciones municipales encargadas de la seguridad
                                                                pública de la entidad
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_instmunot"
                                                                <?php echo $registro_p10_4_instmunot ?> />

                                                            <label class="form-check-label"
                                                                for="registro_p10_4_instmunot">
                                                                Instituciones municipales encargadas de la seguridad
                                                                pública de otras entidades
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_instestot"
                                                                <?php echo $registro_p10_4_instestot ?> />

                                                            <label class="form-check-label"
                                                                for="registro_p10_4_instestot">
                                                                Instituciones estatales encargadas de la seguridad
                                                                pública de otras entidades
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_sec"
                                                                <?php echo $registro_p10_4_sec ?> />

                                                            <label class="form-check-label" for="registro_p10_4_sec">
                                                                Secretaría de Seguridad y Protección Ciudadana
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_guar"
                                                                <?php echo $registro_p10_4_guar ?> />

                                                            <label class="form-check-label" for="registro_p10_4_guar">
                                                                Guardia Nacional
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_procotras"
                                                                <?php echo $registro_p10_4_procotras ?> />

                                                            <label class="form-check-label"
                                                                for="registro_p10_4_procotras">
                                                                Procuraduría General de Justicia o Fiscalía General de
                                                                otras entidades
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_fisc"
                                                                <?php echo $registro_p10_4_fisc ?> />

                                                            <label class="form-check-label" for="registro_p10_4_fisc">
                                                                Fiscalía General de la República
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_podjud"
                                                                <?php echo $registro_p10_4_podjud ?> />

                                                            <label class="form-check-label" for="registro_p10_4_podjud">
                                                                Poder Judicial de la entidad
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_podjudotras"
                                                                <?php echo $registro_p10_4_podjudotras ?> />

                                                            <label class="form-check-label"
                                                                for="registro_p10_4_podjudotras">
                                                                Poder Judicial de otras entidades
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_podfed"
                                                                <?php echo $registro_p10_4_podfed ?> />

                                                            <label class="form-check-label" for="registro_p10_4_podfed">
                                                                Poder Judicial de la Federación
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_sipenent"
                                                                <?php echo $registro_p10_4_sipenent ?> />

                                                            <label class="form-check-label" for="registro_p10_4_sipenent">
                                                                Sistema Penitenciario de la entidad
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_sispen"
                                                                <?php echo $registro_p10_4_sispen ?> />

                                                            <label class="form-check-label" for="registro_p10_4_sispen">
                                                                Sistema Penitenciario de otras entidades
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="registro_p10_4_sispenfed"
                                                                <?php echo $registro_p10_4_sispenfed ?> />

                                                            <label class="form-check-label"
                                                                for="registrop10_4sispenfed">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input group82" type="checkbox"
                                                            name="registro_p10_4_otro"
                                                            id="registro_p10_4_otro"
                                                            onchange="javascript:showContent1004()"
                                                            <?php echo $registro_p10_4_otro ?> />
                                                            <label class="form-check-label"
                                                            for="registro_p10_4_otro">Otro
                                                          </label>

                                                          <div id="content1004" style="display: none;">
                                                            <label class="form-check-label"
                                                            for="registro_p10_4_cual">
                                                            ¿Cuáles?</label>
                                                            <input class="form-control" type="text"
                                                            name="registro_p10_4_cual"
                                                            id="registro_p10_4_cual"
                                                            value="<?php echo $registro_p10_4_cual; ?>"/>
                                                          </div>
                                                          </div>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($indicadores_p11_modeval == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      ...
                                                      <input class="form-check-input" type="radio"
                                                      name="indicadores_p11_modeval" id="indicadores_p11_modeval"
                                                      <?php if ($indicadores_p11_modeval == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea class="form-control" name="indicadores_p11_1_cualind" id="indicadores_p11_1_cualind" rows="10" cols="90" ><?php echo $indicadores_p11_1_cualind; ?></textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                                                                            ...
                                                                                                            <?php if ($indicadores_p12_bunprac == "checked"){echo ' checked="checked"'; }?> />
                                                                                                            <label class="form-check-label"
                                                                                                            ...
                                                                                                            <input class="form-check-input" type="radio"
                                                                                                            name="indicadores_p12_bunprac" id="indicadores_p12_bunprac"
                                                                                                            <?php if ($indicadores_p12_bunprac == "unchecked"){echo ' checked="checked"'; }?> />
                                                                                                            <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea class="form-control" name="transparencia_p12_1_cualpract" id="transparencia_p12_1_cualpract" rows="10" cols="90" ><?php echo $transparencia_p12_1_cualpract; ?></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <form action="#" method="post" class="col-lg-12">
                                            <div>
                                                <h5>
                                                    13.- ¿Qué requiere la institución estatal encargada de la seguridad
                                                    pública para desempeñar correctamente sus funciones?
                                                </h5>
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p13_recmat ?> />
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p13_infra ?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <?php echo $necesidades_p13_otros ?> />
                                                            <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea   class="form-control" name="necesidades_p13_1_desnec" id="necesidades_p13_1_desnec" rows="10" cols="90" ><?php echo $necesidades_p13_1_desnec; ?></textarea>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <?php if ($denunciaserv_p14_den == "checked"){echo ' checked="checked"'; }?> />
                                                          <label class="form-check-label"
                                                          for="denunciaserv_p14_den">Sí</label>
                                                            ...
                                                            <div id="content65" style="display: none;">
                                                                ...
                                                                <input class="form-control" type="text" name="denunciaserv_p14_den_cual"
                                                                    id="denunciaserv_p14_den_cual" value="<?php echo $denunciaserv_p14_den_cual; ?>"/>
                                                            </div>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="denunciaserv_p14_den" id="denunciaserv_p14_den"
                                                                    onchange="javascript:showContent65()"
                                                                    <?php if ($denunciaserv_p14_den == "unchecked"){echo ' checked="checked"'; }?>>
                                                                <label class="form-check-label"
    ...
    <td>7</td>
                      ...
                      ?>
                                            <div>
                                                <h5>
                                                    <!-- aqui -->
                                          14.2.1.-¿Cuentan con un órgano especializado encargado de investigar denuncias contra servidores públicos en materia penal? En caso de que sí, escribir el nombre del órgano responsable.
                    </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                          <input class="form-check-input" type="radio"
                                                          name="denunciaserv_p142_den" id="denunciaserv_p142_den"
                                                          onchange="javascript:showContent652()"
                                                          <?php if ($denunciaserv_p142_den == "checked"){echo ' checked="checked"'; }?> />
                                                          <label class="form-check-label"
                                                          for="denunciaserv_p142_den">Sí</label>
                                                          </div>




                                                            <div id="content652" style="display: none;">
                                                                <label class="form-check-label" for="denunciaserv_p142_den_cual">
                                                                    (¿Cuál?) </label>
                                                                <input class="form-control" type="text" name="denunciaserv_p142_den_cual"
                                                                    id="denunciaserv_p142_den_cual" value="<?php echo $denunciaserv_p142_den_cual; ?>"/>
                                                            </div>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="denunciaserv_p142_den" id="denunciaserv_p142_den"
                                                                    onchange="javascript:showContent65()"
                                                                    <?php if ($denunciaserv_p142_den == "unchecked"){echo ' checked="checked"'; }?>>
                                                                <label class="form-check-label"
                                                                    for="denunciaserv_p142_den">No</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div>
                                                ...
                                                <h5>14.2.2.- Total de denuncias presentadas en el año 2020 contra servidores públicos. Desglosar por función y por sexo.
                                            ...
                                            <!--  Pregunta -->
                                            <div>
                                                <h5>14.2.3.- Total de sentencias condenatorias en contra de servidores públicos en el año 2020. Desglosar por función y por sexo.
</h5>
                                            </div>
                                            <table class="table">
                                                <thead>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea   class="form-control" name="denuncias_p15_numtot" id="denuncias_p15_numtot" rows="10" cols="90" ><?php echo $denuncias_p15_numtot; ?></textarea>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_homi" id="denuncias_p15_1_homi" value="<?php echo $denuncias_p15_1_homi; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>2 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_femi" id="denuncias_p15_1_femi" value="<?php echo $denuncias_p15_1_femi; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>3 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_les" id="denuncias_p15_1_les" value="<?php echo $denuncias_p15_1_les; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>4 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_viofam" id="denuncias_p15_1_viofam" value="<?php echo $denuncias_p15_1_viofam; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>5 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_abusex" id="denuncias_p15_1_abusex" value="<?php echo $denuncias_p15_1_abusex; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>6 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_hossex" id="denuncias_p15_1_hossex" value="<?php echo $denuncias_p15_1_hossex; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>7 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_viol" id="denuncias_p15_1_viol" value="<?php echo $denuncias_p15_1_viol; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>8 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_tratper" id="denuncias_p15_1_tratper" value="<?php echo $denuncias_p15_1_tratper; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>9 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_cormen" id="denuncias_p15_1_cormen" value="<?php echo $denuncias_p15_1_cormen; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                      <td>10 </td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    name="denuncias_p15_1_trafmen" id="denuncias_p15_1_trafmen" value="<?php echo $denuncias_p15_1_trafmen; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($denuncias_p15_2_mecnopre == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      ...
                                                      <input class="form-check-input" type="radio"
                                                      name="denuncias_p15_2_mecnopre" id="denuncias_p15_2_mecnopre"
                                                      <?php if ($denuncias_p15_2_mecnopre == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                    ...
                                                    <tr>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="denuncias_p15_3_pagint"
                                                                  <?php echo $denuncias_p15_3_pagint; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p15_3_sms; ?>/>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <?php echo $necesidades_p15_3_otros ?> />
                                                            <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea   class="form-control" name="denuncias_p15_4_den" id="denuncias_p15_4_den" rows="10" cols="90" ><?php echo $denuncias_p15_4_den; ?></textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($victimas_p17_bprac == "checked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                                      ...
                                                      <input class="form-check-input" type="radio"
                                                      name="victimas_p17_bprac" id="victimas_p17_bprac"
                                                      <?php if ($victimas_p17_bprac == "unchecked"){echo ' checked="checked"'; }?> />
                                                      <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea   class="form-control" name="victimas_p17_1_cuales" id="victimas_p17_1_cuales" rows="10" cols="90" ><?php echo $victimas_p17_1_cuales; ?></textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php if ($justiicia_p18_mesajus == "checked"){echo ' checked="checked"'; }?> />
                                                        <label class="form-check-label"
                                                        ...
                                                        <input class="form-check-input" type="radio"
                                                        name="justiicia_p18_mesajus" id="justiicia_p18_mesajus"
                                                        <?php if ($justiicia_p18_mesajus == "unchecked"){echo ' checked="checked"'; }?> />
                                                        <label class="form-check-label"
                                                    ...
                                                    <tr>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                              ...
                                                              <?php echo $necesidades_p18_1_segobedo; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_uasisjus; ?> />
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_ptrisup; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_fisgral; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_secsegpu; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_secsegpu">
                                                                Secretario/a de Seguridad Pública/ Jefe de la Policía
                                                                u homólogo
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_tinst; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_subsispen; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_subsispen">
                                                                Subsecretario/a del Sistema Penitenciario/ Director
                                                                General u homólogo
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_tautsup; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_tautsup">
                                                                Titular de la Autoridad de Supervisión de Medidas
                                                                Cautelares y de Suspensión Condicional del Proceso
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="necesidades_p18_1_tinsestm" name="necesidades_p18_1_tinsestm"
                                                                <?php echo $necesidades_p18_1_tinsestm; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_dif; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_sipinna; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_secsal; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_comejavic; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_cenuatnvic; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_tcenjusm; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_tcenjusm">
                                                                Titular del Centro de Justicia para Mujeres u
                                                                homólogo
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_tfisespm; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_tfisespm">
                                                                Titular de Fiscalía Especializada delitos en razón de género
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="necesidades_p18_1_dcenpen" name="necesidades_p18_1_dcenpen"
                                                                <?php echo $necesidades_p18_1_dcenpen; ?>/>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_dcenpenadol; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_dcenpenadol">
                                                                Director/a de Centros de internamiento para
                                                                adolescentes
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_torgmec; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_torgmec">
                                                                Titular del Órgano de Mecanismos Alternativos de
                                                                Solución de Controversias en materia Penal u homólogo
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="necesidades_p18_1_tsevper" name="necesidades_p18_1_tsevper"
                                                                <?php echo $necesidades_p18_1_tsevper; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_tsevper">
                                                                Titular de Servicios Periciales y Forenses u
                                                                homólogo
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php echo $necesidades_p18_1_otros; ?>/>
                                                            <label class="form-check-label" for="necesidades_p18_1_otros">
                                                                Otros (¿cuales?)
                                                                <br>
                                                                <input class="form-control" type="text"
                                                                    name="necesidades_p18_1_cual" id="necesidades_p18_1_cual"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="justiicia_p18_2_semanal" name="justiicia_p18_2_semanal"
                                                                <?php echo $justiicia_p18_2_semanal; ?>/>
                                                            <label class="form-check-label" for="justiicia_p18_2_semanal">
                                                                Semanal
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="justiicia_p18_2_quincenal" name="justiicia_p18_2_quincenal"
                                                                <?php echo $justiicia_p18_2_quincenal; ?>/>
                                                            <label class="form-check-label" for="justiicia_p18_2_quincenal">
                                                                Quincenal
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="justiicia_p18_2_mensual" name="justiicia_p18_2_mensual"
                                                                <?php echo $justiicia_p18_2_mensual; ?>/>
                                                            <label class="form-check-label" for="justiicia_p18_2_mensual">
                                                                Mensual
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="justiicia_p18_2_bimestral" name="justiicia_p18_2_bimestral"
                                                                <?php echo $justiicia_p18_2_bimestral; ?>/>
                                                            <label class="form-check-label" for="justiicia_p18_2_bimestral">
                                                                Bimestral
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="justiicia_p18_2_trimestral" name="justiicia_p18_2_trimestral"
                                                                <?php echo $justiicia_p18_2_trimestral; ?>/>
                                                            <label class="form-check-label" for="justiicia_p18_2_trimestral">
                                                                Trimestral
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="justiicia_p18_2_semestral" name="justiicia_p18_2_semestral"
                                                                <?php echo $justiicia_p18_2_semestral; ?>/>
                                                            <label class="form-check-label" for="justiicia_p18_2_semestral">
                                                                Semestral
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="justiicia_p18_2_anual" name="justiicia_p18_2_anual"
                                                                <?php echo $justiicia_p18_2_anual; ?>/>
                                                            <label class="form-check-label" for="justiicia_p18_2_anual">
                                                                Anual
                                                            </label>
                                                        </div>
                                                    </tr>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea   class="form-control" name="justiicia_p18_3_buenpract" id="justiicia_p18_3_buenpract" rows="10" cols="90" ><?php echo $justiicia_p18_3_buenpract; ?></textarea>

                                                    </tr>
                                                </tbody>
                                            </table>
                                            <input style="right: 20%;!important;" type="button" value="Finalizar"
                                                  class="btn btn-success btn-flotante crearTab8fin" />
<div>
                                            <input type="button" value="Guardar cambios"
                                    ...
                                    <div class="form-group">
                                        <form action="#" method="post" class="col-lg-12">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    <?php if ($impacto_p19_medprev == "checked"){echo ' checked="checked"'; }?>/>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="impacto_p19_medprev" id="impacto_p19_medprev"
                                                                   <?php if ($impacto_p19_medprev == "unchecked"){echo ' checked="checked"'; }?>/>
                                                                <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      <textarea   class="form-control" name="impacto_p19_1_medse" id="impacto_p19_1_medse" rows="10" cols="90" ><?php echo $impacto_p19_1_medse; ?></textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    <?php if ($impacto_p19_2_incmed == "checked"){echo ' checked="checked"'; }?>>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="impacto_p19_2_incmed" id="impacto_p19_2_incmed"
                                                                    <?php if ($impacto_p19_2_incmed == "unchecked"){echo ' checked="checked"'; }?>>
                                                                <label class="form-check-label"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea   class="form-control" name="impacto_p19_3_descmed" id="impacto_p19_3_descmed" rows="10" cols="90" ><?php echo $impacto_p19_3_descmed; ?></textarea>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  ...
                                                                  <?php if ($terapeutica_p20_progjus == "checked"){echo ' checked="checked"'; }?>>
                                                              <label class="form-check-label"
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio"
                                                                  name="terapeutica_p20_progjus" id="terapeutica_p20_progjus"
                                                                  <?php if ($terapeutica_p20_progjus == "unchecked"){echo ' checked="checked"'; }?>>
                                                              <label class="form-check-label"
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                              ...
                                                              <textarea   class="form-control" name="comfin" id="comfin" rows="10" cols="90" ><?php echo $comfin; ?></textarea>
                                                                                  <!--  Fin  Pregunta  -->
        ...
        $(function() {
         ...
         function enable_cb74() {
            if (this.checked) {
                $("input.group74").attr("disabled", true).attr("unchecked", true);
            } else {
                $("input.group74").removeAttr("disabled");
            }
        }
    ...
    $(function() {
     ...
     function enable_cb64() {
        if (this.checked) {
            $("input.group64").attr("disabled", true).attr("unchecked", true);
        } else {
            $("input.group64").removeAttr("disabled");
        }
    }
  ...
  <script type="text/javascript">
    $(function() {
        enable_cb50();
        $("#nna_p5_ninguno").click(enable_cb50);
    });

    function enable_cb50() {
        if (this.checked) {
            $("input.group50").attr("disabled", true).attr("unchecked", true);
        } else {
            $("input.group50").removeAttr("disabled");
        }
    }
...
$(function() {
    enable_cb2();
    $("#mujeres_p4_ninguno").click(enable_cb2);
});
...
function enable_cb2() {
    if (this.checked) {
        ...
        $("input.group1").attr("unchecked", true);
    }
}
...
$(function() {
 ...
 function enable_cb82() {
    if (this.checked) {
        $("input.group82").attr("disabled", true).attr("unchecked", true);
    } else {
        $("input.group82").removeAttr("disabled");
    }
}
...
//= document.getElementById("mujeres_p4_protoInterna");
...
$(".panel-body").on("click", ".crearTab2", function() {
  ...
  var personal_p1_totalp_T = $("#personal_p1_totalp_T").val();
    ...
    if ($("#capacitacion_p2_2_otro").is(":checked")) {
        ...
        var capacitacion_p2_2_otro = "unchecked";
    }
    ...
    if ($("#presupuesto_p3").is(":checked")) {
        var presupuesto_p3 = "checked";
    } else {
        var presupuesto_p3 = "unchecked";
    }
...
var mujeres_p4_otroProtocolo_cual = $("#mujeres_p4_otroProtocolo_cual").val();
    ...
    if ($("#mujeres_p4_1_buenprac").is(":checked")) {
        var mujeres_p4_1_buenprac = "checked";
    } else {
        var mujeres_p4_1_buenprac = "unchecked";
    }
    ...
    if ($("#nna_p5_protoAteninte").is(":checked")) {
        var nna_p5_protoAteninte = "checked";
    } else {
        var nna_p5_protoAteninte = "unchecked";
    }


    if ($("#nna_p5_protoActjust").is(":checked")) {
        var nna_p5_protoActjust = "checked";
    } else {
        var nna_p5_protoActjust = "unchecked";
    }


        if ($("#nna_p5_ninguno").is(":checked")) {
            var nna_p5_ninguno = "checked";
        } else {
            var nna_p5_ninguno = "unchecked";
        }



    if ($("#nna_p5_otroProtocolo").is(":checked")) {
        var nna_p5_otroProtocolo = "checked";
    } else {
        var nna_p5_otroProtocolo = "unchecked";
    }
    ...
    if ($("#nna_p5_1_buenprac").is(":checked")) {
        var nna_p5_1_buenprac = "checked";
    } else {
        var nna_p5_1_buenprac = "unchecked";
    }
    ...
    if ($("#indigenas_p6_tradulenind").is(":checked")) {
        var indigenas_p6_tradulenind = "checked";
    } else {
        var indigenas_p6_tradulenind = "unchecked";
    }
    ...
    if ($("#indigenas_p6_2_convenio").is(":checked")) {
        var indigenas_p6_2_convenio = "checked";
    } else {
        var indigenas_p6_2_convenio = "unchecked";
    }
    ...
    if ($("#indigenas_p6_4_ProtoInter").is(":checked")) {
        var indigenas_p6_4_ProtoInter = "checked";
    } else {
        var indigenas_p6_4_ProtoInter = "unchecked";
    }

    var indigenas_p6_4_ProtoInter_cual = $("#indigenas_p6_4_ProtoInter_cual").val();

    if ($("#indigenas_p6_4_interno").is(":checked")) {
        var indigenas_p6_4_interno = "checked";
    } else {
        var indigenas_p6_4_interno = "unchecked";
    }

    var indigenas_p6_4_interno_cual = $("#indigenas_p6_4_interno_cual").val();

    if ($("#indigenas_p6_4_ProtoImpjust").is(":checked")) {
        var indigenas_p6_4_ProtoImpjust = "checked";
    } else {
        var indigenas_p6_4_ProtoImpjust = "unchecked";
    }

    if ($("#indigenas_p6_4_ninguno").is(":checked")) {
        var indigenas_p6_4_ninguno = "checked";
    } else {
        var indigenas_p6_4_ninguno = "unchecked";
    }


    if ($("#indigenas_p6_4_otro").is(":checked")) {
        var indigenas_p6_4_otro = "checked";
    } else {
        var indigenas_p6_4_otro = "unchecked";
    }
    ...
    var indigenas_p6_4_otro_cual = $("#indigenas_p6_4_otro_cual").val();
        ...
        if ($("#indigenas_p6_5_buenaspract").is(":checked")) {
            var indigenas_p6_5_buenaspract = "checked";
        } else {
            var indigenas_p6_5_buenaspract = "unchecked";
        }
    ...
    datos.append("nna_p5_1_buenprac", nna_p5_1_buenprac);
...
$(".panel-body").on("click", ".crearTab4", function() {
    ...
    if ($("#extranjeras_p7_tradLenExt").is(":checked")) {
        var extranjeras_p7_tradLenExt = "checked";
    } else {
        var extranjeras_p7_tradLenExt = "unchecked";
    }
    ...
    if ($("#extranjeras_p7_2_ConvInst").is(":checked")) {
        var extranjeras_p7_2_ConvInst = "checked";
    } else {
        var extranjeras_p7_2_ConvInst = "unchecked";
    }
    var extranjeras_p7_3_nombreInsti = $("#extranjeras_p7_3_nombreInsti").val();

    if ($("#extranjeras_p7_4_ProtoInterna").is(":checked")) {
        var extranjeras_p7_4_ProtoInterna = "checked";
    } else {
        var extranjeras_p7_4_ProtoInterna = "unchecked";
    }

    if ($("#extranjeras_p7_4_interno").is(":checked")) {
        var extranjeras_p7_4_interno = "checked";
    } else {
        var extranjeras_p7_4_interno = "unchecked";
    }

    if ($("#extranjeras_p7_4_ninguno").is(":checked")) {
        var extranjeras_p7_4_ninguno = "checked";
    } else {
        var extranjeras_p7_4_ninguno = "unchecked";
    }

    if ($("#extranjeras_p7_4_Otro").is(":checked")) {
        var extranjeras_p7_4_Otro = "checked";
    } else {
        var extranjeras_p7_4_Otro = "unchecked";
    }
    ...
    if ($("#extranjeras_p7_5_buenasprac").is(":checked")) {
        var extranjeras_p7_5_buenasprac = "checked";
    } else {
        var extranjeras_p7_5_buenasprac = "unchecked";
    }
    var extranjeras_p7_6_buenasprac_cual = $("#extranjeras_p7_6_buenasprac_cual").val();
    if ($("#discapacidad_p8_braile").is(":checked")) {
        var discapacidad_p8_braile = "checked";
    } else {
        var discapacidad_p8_braile = "unchecked";
    }

    if ($("#discapacidad_p8_LenSen").is(":checked")) {
        var discapacidad_p8_LenSen = "checked";
    } else {
        var discapacidad_p8_LenSen = "unchecked";
    }
    var discapacidad_p8_1_nombreInst = $("#discapacidad_p8_1_nombreInst").val();


    if ($("#discapacidad_p8_2_ProtoInterna").is(":checked")) {
        var discapacidad_p8_2_ProtoInterna = "checked";
    } else {
        var discapacidad_p8_2_ProtoInterna = "unchecked";
    }

    var discapacidad_p8_2_ProtoInterna_cual = $("#discapacidad_p8_2_ProtoInterna_cual").val();

    if ($("#discapacidad_p8_2_interno").is(":checked")) {
        var discapacidad_p8_2_interno = "checked";
    } else {
        var discapacidad_p8_2_interno = "unchecked";
    }

    var discapacidad_p8_2_interno_cua = $("#discapacidad_p8_2_interno_cua").val();

    if ($("#discapacidad_p8_2_ProtoImpJust").is(":checked")) {
        var discapacidad_p8_2_ProtoImpJust = "checked";
    } else {
        var discapacidad_p8_2_ProtoImpJust = "unchecked";
    }


    if ($("#discapacidad_p8_2_ninguno").is(":checked")) {
        var discapacidad_p8_2_ninguno = "checked";
    } else {
        var discapacidad_p8_2_ninguno = "unchecked";
    }


    if ($("#discapacidad_p8_2_otros").is(":checked")) {
        var discapacidad_p8_2_otros = "checked";
    } else {
        var discapacidad_p8_2_otros = "unchecked";
    }
    ...
    if ($("#discapacidad_p8_3_buenasprac").is(":checked")) {
        var discapacidad_p8_3_buenasprac = "checked";
    } else {
        var discapacidad_p8_3_buenasprac = "unchecked";
    }
...
$(".panel-body").on("click", ".crearTab5", function() {
    ...
    if ($("#colaboracion_p9_tipcol").is(":checked")) {
        var colaboracion_p9_tipcol = "checked";
    } else {
        var colaboracion_p9_tipcol = "unchecked";
    }

    var colaboracion_p9_1_instcol = $("#colaboracion_p9_1_instcol").val();

    if ($("#colaboracion_p9_2_finan").is(":checked")) {
        var colaboracion_p9_2_finan = "checked";
    } else {
        var colaboracion_p9_2_finan = "unchecked";
    }


    if ($("#colaboracion_p9_2_dona").is(":checked")) {
        var colaboracion_p9_2_dona = "checked";
    } else {
        var colaboracion_p9_2_dona = "unchecked";
    }


    if ($("#colaboracion_p9_2_capa").is(":checked")) {
        var colaboracion_p9_2_capa = "checked";
    } else {
        var colaboracion_p9_2_capa = "unchecked";
    }

    if ($("#colaboracion_p9_2_otros").is(":checked")) {
        var colaboracion_p9_2_otros = "checked";
    } else {
        var colaboracion_p9_2_otros = "unchecked";
    }
    ...
    if ($("#registro_p10_lib").is(":checked")) {
        var registro_p10_lib = "checked";
    } else {
        var registro_p10_lib = "unchecked";
    }

    if ($("#registro_p10_imp").is(":checked")) {
        var registro_p10_imp = "checked";
    } else {
        var registro_p10_imp = "unchecked";
    }

    if ($("#registro_p10_tab").is(":checked")) {
        var registro_p10_tab = "checked";
    } else {
        var registro_p10_tab = "unchecked";
    }

    if ($("#registro_p10_cel").is(":checked")) {
        var registro_p10_cel = "checked";
    } else {
        var registro_p10_cel = "unchecked";
    }

    if ($("#registro_p10_comp").is(":checked")) {
        var registro_p10_comp = "checked";
    } else {
        var registro_p10_comp = "unchecked";
    }

    if ($("#registro_p10_otro").is(":checked")) {
        var registro_p10_otro = "checked";
    } else {
        var registro_p10_otro = "unchecked";
    }

    var registro_p10_cual = $("#registro_p10_cual").val();

    if ($("#registro_p10_1_ind").is(":checked")) {
        var registro_p10_1_ind = "checked";
    } else {
        var registro_p10_1_ind = "unchecked";
    }

    if ($("#registro_p10_1_per").is(":checked")) {
        var registro_p10_1_per = "checked";
    } else {
        var registro_p10_1_per = "unchecked";
    }

    if ($("#registro_p10_1_cap").is(":checked")) {
        var registro_p10_1_cap = "checked";
    } else {
        var registro_p10_1_cap = "unchecked";
    }

    if ($("#registro_p10_1_perdet").is(":checked")) {
        var registro_p10_1_perdet = "checked";
    } else {
        var registro_p10_1_perdet = "unchecked";
    }

    if ($("#registro_p10_1_del").is(":checked")) {
        var registro_p10_1_del = "checked";
    } else {
        var registro_p10_1_del = "unchecked";
    }

    if ($("#registro_p10_1_vic").is(":checked")) {
        var registro_p10_1_vic = "checked";
    } else {
        var registro_p10_1_vic = "unchecked";
    }

    if ($("#registro_p10_1_perdes").is(":checked")) {
        var registro_p10_1_perdes = "checked";
    } else {
        var registro_p10_1_perdes = "unchecked";
    }
    if ($("#registro_p10_1_den").is(":checked")) {
        var registro_p10_1_den = "checked";
    } else {
        var registro_p10_1_den = "unchecked";
    }


    if ($("#registro_p10_1_pedetfad").is(":checked")) {
        var registro_p10_1_pedetfad = "checked";
    } else {
        var registro_p10_1_pedetfad = "unchecked";
    }
    if ($("#registro_p10_1_pedetpdis").is(":checked")) {
        var registro_p10_1_pedetpdis = "checked";
    } else {
        var registro_p10_1_pedetpdis = "unchecked";
    }
    if ($("#registro_p10_1_llam").is(":checked")) {
        var registro_p10_1_llam = "checked";
    } else {
        var registro_p10_1_llam = "unchecked";
    }

    if ($("#registro_p10_1_dil").is(":checked")) {
        var registro_p10_1_dil = "checked";
    } else {
        var registro_p10_1_dil = "unchecked";
    }

    if ($("#registro_p10_1_part").is(":checked")) {
        var registro_p10_1_part = "checked";
    } else {
        var registro_p10_1_part = "unchecked";
    }
    ...
    if ($("#registro_p10_1_atn").is(":checked")) {
        var registro_p10_1_atn = "checked";
    } else {
        var registro_p10_1_atn = "unchecked";
    }
    if ($("#registro_p10_1_actu").is(":checked")) {
        var registro_p10_1_actu = "checked";
    } else {
        var registro_p10_1_actu = "unchecked";
    }
    if ($("#registro_p10_1_otros").is(":checked")) {
        var registro_p10_1_otros = "checked";
    } else {
        var registro_p10_1_otros = "unchecked";
    }
    ...
    if ($("#registro_p10_2_lib").is(":checked")) {
        var registro_p10_2_lib = "checked";
    } else {
        var registro_p10_2_lib = "unchecked";
    }

    if ($("#registro_p10_2_bd").is(":checked")) {
        var registro_p10_2_bd = "checked";
    } else {
        var registro_p10_2_bd = "unchecked";
    }


    if ($("#registro_p10_2_ap").is(":checked")) {
        var registro_p10_2_ap = "checked";
    } else {
        var registro_p10_2_ap = "unchecked";
    }

    if ($("#registro_p10_2_plat").is(":checked")) {
        var registro_p10_2_plat = "checked";
    } else {
        var registro_p10_2_plat = "unchecked";
    }


    if ($("#registro_p10_2_cap").is(":checked")) {
        var registro_p10_2_cap = "checked";
    } else {
        var registro_p10_2_cap = "unchecked";
    }


    if ($("#registro_p10_2_otro").is(":checked")) {
        var registro_p10_2_otro = "checked";
    } else {
        var registro_p10_2_otro = "unchecked";
    }
    ...
    if ($("#registro_p10_4_instmun").is(":checked")) {
        var registro_p10_4_instmun = "checked";
    } else {
        var registro_p10_4_instmun = "unchecked";
    }

    if ($("#registro_p10_4_instmunot").is(":checked")) {
        var registro_p10_4_instmunot = "checked";
    } else {
        var registro_p10_4_instmunot = "unchecked";
    }

    if ($("#registro_p10_4_instestot").is(":checked")) {
        var registro_p10_4_instestot = "checked";
    } else {
        var registro_p10_4_instestot = "unchecked";
    }

    if ($("#registro_p10_4_sec").is(":checked")) {
        var registro_p10_4_sec = "checked";
    } else {
        var registro_p10_4_sec = "unchecked";
    }

    if ($("#registro_p10_4_guar").is(":checked")) {
        var registro_p10_4_guar = "checked";
    } else {
        var registro_p10_4_guar = "unchecked";
    }

    if ($("#registro_p10_4_procotras").is(":checked")) {
        var registro_p10_4_procotras = "checked";
    } else {
        var registro_p10_4_procotras = "unchecked";
    }


    if ($("#registro_p10_4_fisc").is(":checked")) {
        var registro_p10_4_fisc = "checked";
    } else {
        var registro_p10_4_fisc = "unchecked";
    }


    if ($("#registro_p10_4_podjud").is(":checked")) {
        var registro_p10_4_podjud = "checked";
    } else {
        var registro_p10_4_podjud = "unchecked";
    }


    if ($("#registro_p10_4_podjudotras").is(":checked")) {
        var registro_p10_4_podjudotras = "checked";
    } else {
        var registro_p10_4_podjudotras = "unchecked";
    }


    if ($("#registro_p10_4_podfed").is(":checked")) {
        var registro_p10_4_podfed = "checked";
    } else {
        var registro_p10_4_podfed = "unchecked";
    }


    if ($("#registro_p10_4_sipenent").is(":checked")) {
        var registro_p10_4_sipenent = "checked";
    } else {
        var registro_p10_4_sipenent = "unchecked";
    }



    if ($("#registro_p10_4_sispen").is(":checked")) {
        var registro_p10_4_sispen = "checked";
    } else {
        var registro_p10_4_sispen = "unchecked";
    }


    if ($("#registro_p10_4_sispenfed").is(":checked")) {
        var registro_p10_4_sispenfed = "checked";
    } else {
        var registro_p10_4_sispenfed = "unchecked";
    }


    if ($("#registro_p10_4_otro").is(":checked")) {
        var registro_p10_4_otro = "checked";
    } else {
        var registro_p10_4_otro = "unchecked";
    }
...
$(".panel-body").on("click", ".crearTab6", function() {
    ...
    if ($("#indicadores_p11_modeval").is(":checked")) {
        var indicadores_p11_modeval = "checked";
    } else {
        var indicadores_p11_modeval = "unchecked";
    }
    ...
    if ($("#indicadores_p12_bunprac").is(":checked")) {
        var indicadores_p12_bunprac = "checked";
    } else {
        var indicadores_p12_bunprac = "unchecked";
    }
    var transparencia_p12_1_cualpract = $("#transparencia_p12_1_cualpract").val();

    if ($("#necesidades_p13_cap").is(":checked")) {
        var necesidades_p13_cap = "checked";
    } else {
        var necesidades_p13_cap = "unchecked";
    }
    if ($("#necesidades_p13_recmat").is(":checked")) {
        var necesidades_p13_recmat = "checked";
    } else {
        var necesidades_p13_recmat = "unchecked";
    }
    if ($("#necesidades_p13_rectec").is(":checked")) {
        var necesidades_p13_rectec = "checked";
    } else {
        var necesidades_p13_rectec = "unchecked";
    }
    if ($("#necesidades_p13_per").is(":checked")) {
        var necesidades_p13_per = "checked";
    } else {
        var necesidades_p13_per = "unchecked";
    }
    if ($("#necesidades_p13_infra").is(":checked")) {
        var necesidades_p13_infra = "checked";
    } else {
        var necesidades_p13_infra = "unchecked";
    }
    if ($("#necesidades_p13_mej").is(":checked")) {
        var necesidades_p13_mej = "checked";
    } else {
        var necesidades_p13_mej = "unchecked";
    }
    if ($("#necesidades_p13_prot").is(":checked")) {
        var necesidades_p13_prot = "checked";
    } else {
        var necesidades_p13_prot = "unchecked";
    }
    if ($("#necesidades_p13_otros").is(":checked")) {
        var necesidades_p13_otros = "checked";
    } else {
        var necesidades_p13_otros = "unchecked";
    }
...
$(".panel-body").on("click", ".crearTab7", function() {
    ...
    if ($("#denunciaserv_p14_den").is(":checked")) {
        var denunciaserv_p14_den = "checked";
    } else {
        var denunciaserv_p14_den = "unchecked";
    }
    ...
    if ($("#denunciaserv_p14_1_orginv").is(":checked")) {
        var denunciaserv_p14_1_orginv = "checked";
    } else {
        var denunciaserv_p14_1_orginv = "unchecked";
    }
    ...
    if ($("#denunciaserv_p142_den").is(":checked")) {
        var denunciaserv_p142_den = "checked";
    } else {
        var denunciaserv_p142_den = "unchecked";
    }
    ...
    if ($("#denuncias_p15_2_mecnopre").is(":checked")) {
        var denuncias_p15_2_mecnopre = "checked";
    } else {
        var denuncias_p15_2_mecnopre = "unchecked";
    }

    if ($("#denuncias_p15_3_pagint").is(":checked")) {
        var denuncias_p15_3_pagint = "checked";
    } else {
        var denuncias_p15_3_pagint = "unchecked";
    }

    if ($("#denuncias_p15_3_tel").is(":checked")) {
        var denuncias_p15_3_tel = "checked";
    } else {
        var denuncias_p15_3_tel = "unchecked";
    }

    if ($("#denuncias_p15_3_app").is(":checked")) {
        var denuncias_p15_3_app = "checked";
    } else {
        var denuncias_p15_3_app = "unchecked";
    }

    if ($("#necesidades_p15_3_sms").is(":checked")) {
        var necesidades_p15_3_sms = "checked";
    } else {
        var necesidades_p15_3_sms = "unchecked";
    }

    if ($("#necesidades_p15_3_otros").is(":checked")) {
        var necesidades_p15_3_otros = "checked";
    } else {
        var necesidades_p15_3_otros = "unchecked";
    }
    ...
    if ($("#victimas_p17_bprac").is(":checked")) {
        var victimas_p17_bprac = "checked";
    } else {
        var victimas_p17_bprac = "unchecked";
    }
...
$(".panel-body").on("click", ".crearTab8", function() {
    ...
    if ($("#justiicia_p18_mesajus").is(":checked")) {
        var justiicia_p18_mesajus = "checked";
    } else {
        var justiicia_p18_mesajus = "unchecked";
    }

    if ($("#necesidades_p18_1_segobedo").is(":checked")) {
        var necesidades_p18_1_segobedo = "checked";
    } else {
        var necesidades_p18_1_segobedo = "unchecked";
    }

    if ($("#necesidades_p18_1_uasisjus").is(":checked")) {
        var necesidades_p18_1_uasisjus = "checked";
    } else {
        var necesidades_p18_1_uasisjus = "unchecked";
    }

    if ($("#necesidades_p18_1_ptrisup").is(":checked")) {
        var necesidades_p18_1_ptrisup = "checked";
    } else {
        var necesidades_p18_1_ptrisup = "unchecked";
    }

    if ($("#necesidades_p18_1_fisgral").is(":checked")) {
        var necesidades_p18_1_fisgral = "checked";
    } else {
        var necesidades_p18_1_fisgral = "unchecked";
    }

    if ($("#necesidades_p18_1_secsegpu").is(":checked")) {
        var necesidades_p18_1_secsegpu = "checked";
    } else {
        var necesidades_p18_1_secsegpu = "unchecked";
    }

    if ($("#necesidades_p18_1_tinst").is(":checked")) {
        var necesidades_p18_1_tinst = "checked";
    } else {
        var necesidades_p18_1_tinst = "unchecked";
    }

    if ($("#necesidades_p18_1_subsispen").is(":checked")) {
        var necesidades_p18_1_subsispen = "checked";
    } else {
        var necesidades_p18_1_subsispen = "unchecked";
    }

    if ($("#necesidades_p18_1_tautsup").is(":checked")) {
        var necesidades_p18_1_tautsup = "checked";
    } else {
        var necesidades_p18_1_tautsup = "unchecked";
    }

    if ($("#necesidades_p18_1_tinsestm").is(":checked")) {
        var necesidades_p18_1_tinsestm = "checked";
    } else {
        var necesidades_p18_1_tinsestm = "unchecked";
    }

    if ($("#necesidades_p18_1_dif").is(":checked")) {
        var necesidades_p18_1_dif = "checked";
    } else {
        var necesidades_p18_1_dif = "unchecked";
    }

    if ($("#necesidades_p18_1_sipinna").is(":checked")) {
        var necesidades_p18_1_sipinna = "checked";
    } else {
        var necesidades_p18_1_sipinna = "unchecked";
    }

    if ($("#necesidades_p18_1_secsal").is(":checked")) {
        var necesidades_p18_1_secsal = "checked";
    } else {
        var necesidades_p18_1_secsal = "unchecked";
    }

    if ($("#necesidades_p18_1_comejavic").is(":checked")) {
        var necesidades_p18_1_comejavic = "checked";
    } else {
        var necesidades_p18_1_comejavic = "unchecked";
    }

    if ($("#necesidades_p18_1_cenuatnvic").is(":checked")) {
        var necesidades_p18_1_cenuatnvic = "checked";
    } else {
        var necesidades_p18_1_cenuatnvic = "unchecked";
    }

    if ($("#necesidades_p18_1_tcenjusm").is(":checked")) {
        var necesidades_p18_1_tcenjusm = "checked";
    } else {
        var necesidades_p18_1_tcenjusm = "unchecked";
    }

    if ($("#necesidades_p18_1_tfisespm").is(":checked")) {
        var necesidades_p18_1_tfisespm = "checked";
    } else {
        var necesidades_p18_1_tfisespm = "unchecked";
    }

    if ($("#necesidades_p18_1_dcenpen").is(":checked")) {
        var necesidades_p18_1_dcenpen = "checked";
    } else {
        var necesidades_p18_1_dcenpen = "unchecked";
    }

    if ($("#necesidades_p18_1_dcenpenadol").is(":checked")) {
        var necesidades_p18_1_dcenpenadol = "checked";
    } else {
        var necesidades_p18_1_dcenpenadol = "unchecked";
    }

    if ($("#necesidades_p18_1_torgmec").is(":checked")) {
        var necesidades_p18_1_torgmec = "checked";
    } else {
        var necesidades_p18_1_torgmec = "unchecked";
    }

    if ($("#necesidades_p18_1_tsevper").is(":checked")) {
        var necesidades_p18_1_tsevper = "checked";
    } else {
        var necesidades_p18_1_tsevper = "unchecked";
    }

    if ($("#necesidades_p18_1_otros").is(":checked")) {
        var necesidades_p18_1_otros = "checked";
    } else {
        var necesidades_p18_1_otros = "unchecked";
    }

    var necesidades_p18_1_cual = $("#necesidades_p18_1_cual").val();

    if ($("#justiicia_p18_2_semanal").is(":checked")) {
        var justiicia_p18_2_semanal = "checked";
    } else {
        var justiicia_p18_2_semanal = "unchecked";
    }

    if ($("#justiicia_p18_2_quincenal").is(":checked")) {
        var justiicia_p18_2_quincenal = "checked";
    } else {
        var justiicia_p18_2_quincenal = "unchecked";
    }

    if ($("#justiicia_p18_2_mensual").is(":checked")) {
        var justiicia_p18_2_mensual = "checked";
    } else {
        var justiicia_p18_2_mensual = "unchecked";
    }

    if ($("#justiicia_p18_2_bimestral").is(":checked")) {
        var justiicia_p18_2_bimestral = "checked";
    } else {
        var justiicia_p18_2_bimestral = "unchecked";
    }

    if ($("#justiicia_p18_2_trimestral").is(":checked")) {
        var justiicia_p18_2_trimestral = "checked";
    } else {
        var justiicia_p18_2_trimestral = "unchecked";
    }

    if ($("#justiicia_p18_2_semestral").is(":checked")) {
        var justiicia_p18_2_semestral = "checked";
    } else {
        var justiicia_p18_2_semestral = "unchecked";
    }

    if ($("#justiicia_p18_2_anual").is(":checked")) {
        var justiicia_p18_2_anual = "checked";
    } else {
        var justiicia_p18_2_anual = "unchecked";
    }

    var justiicia_p18_3_buenpract = $("#justiicia_p18_3_buenpract").val();

    if ($("#impacto_p19_medprev").is(":checked")) {
        var impacto_p19_medprev = "checked";
    } else {
        var impacto_p19_medprev = "unchecked";
    }

    var impacto_p19_1_medse = $("#impacto_p19_1_medse").val();

    if ($("#impacto_p19_2_incmed").is(":checked")) {
        var impacto_p19_2_incmed = "checked";
    } else {
        var impacto_p19_2_incmed = "unchecked";
    }
    ...
    if ($("#terapeutica_p20_progjus").is(":checked")) {
        var terapeutica_p20_progjus = "checked";
    } else {
        var terapeutica_p20_progjus = "unchecked";
    }
