...
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m1.png" width="40%" height="40%">
</div>
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m2.png" width="40%" height="40%">
</div>
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m3.png" width="40%" height="40%">
</div>
<br>
<blockquote style="font-size: 1em;">
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m4.png" width="40%" height="40%">
</div>
<br>
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m5.png" width="40%">
</div>
<br>
<blockquote style="font-size: 1em;">
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m6.png" width="40%" height="40%">
<br><img src="https://unidaddejusticia.com/registro/hide/vistas/img/m6.1.png" width="40%" height="40%">
</div>
<br>
<blockquote style="font-size: 1em;">
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m7.png" width="40%" height="40%">
</div>
<br>
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m8.png" width="40%" height="40%">
<br><img src="https://unidaddejusticia.com/registro/hide/vistas/img/m8.1.png" width="40%" height="40%">
</div>
<br>
...
<div style=" text-align: center;">
<img src="https://unidaddejusticia.com/registro/hide/vistas/img/m9.png" width="40%" height="40%">
</div>
<blockquote style="font-size: 1em;">
...
<td>1</td>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" min="0" pattern="^[0-9]+" class="form-control <?php if($estatus == 0){echo  "group12";}?>"
                                                    ...
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                            <label class="form-check-label" for="capacitacion_p2">
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                              <label class="form-check-label" for="capacitacion_p2_no">
                                                                <input class="form-check-input" type="radio"
                                                                  name="capacitacion_p2" id="capacitacion_p2_no"
                                                                  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea     <?php if($estatus != 0) { echo "readonly='true'"; } ?>   <?php if($capacitacion_p2 == "No") { echo "readonly='true'"; } ?> class="form-control" name="capacitacion_p2_1_nom"
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" min="0" pattern="^[0-9]+" class="form-control <?php if($estatus == 0){echo  "group23";}?>"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                <label class="form-check-label" for="presupuesto_p3">
                                                                  <input class="form-check-input" type="radio"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <label class="form-check-label"  for="presupuesto_p3_no">
                                                                  <input class="form-check-input" type="radio"
                                                                    name="presupuesto_p3" id="presupuesto_p3_no"
                                                                    <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            class="form-check-input <?php if($estatus == 0){echo  "group04";}?> " type="checkbox"
                                                                ...
                                                                <?php
                                                                if ($mujeres_p4_protoInterna == "Protocolo internacional"){
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                          <label class="form-check-label" for="$mujeres_p4_protoInvmipp">   <input <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                          class="form-check-input <?php if($estatus == 0){echo  "group04";}?>" type="checkbox"
                                                          ...
                                                          <label  class="form-check-label" for="mujeresp4">
                                                            ...
                                                            <div id="content400" style="display: none;">
                                                                <label class="form-check-label " for="mujeres_p4_otroProtocolo_cual">
                                                                    ¿Cuáles? </label>
                                                                <input <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                                class="form-control group04" type="text" name="mujeres_p4_otroProtocolo_cual"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                <label class="form-check-label" for="mujeres_p4_1_buenprac">
                                                                  <input class="form-check-input" type="radio"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <label class="form-check-label" for="mujeres_p4_1_buenprac_no">
                                                                  <input class="form-check-input" type="radio"
                                                                    name="mujeres_p4_1_buenprac" id="mujeres_p4_1_buenprac_no"
                                                                    <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                    ...
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea   <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                            ...
                                                            class="form-control" name="mujeres_p4_2_cualBuenprac"
                                        ...
                                        <form action="#" method="post" class="col-lg-12">
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      <div class="form-check form-check-inline">
                                                          <input class="form-check-input <?php if($estatus == 0){echo  "group05";}?>" type="checkbox"
                                                          ...
                                                          <div id="content11" style="display: none;">
                                                              <label class="form-check-label"
                                                                  ...
                                                                  (¿Cuáles?) </label>
                                                              <input class="form-control group05" type="text"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                          ...
                                                          <div id="content99" style="display: none;">
                                                              <label class="form-check-label" for="nna_p5_otroProtocolo_cual">
                                                                  (¿Cuáles?) </label>
                                                              <input class="form-control group05" type="text" name="nna_p5_otroProtocolo_cual"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                            <label class="form-check-label" for="nna_p5_1_buenpracs">
                                                              <input class="form-check-input" type="radio"
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                              <label class="form-check-label" for="nna_p5_1_buenpracs_no">
                                                              <input class="form-check-input" type="radio"
                                                                  name="nna_p5_1_buenpracs" id="nna_p5_1_buenpracs_no"
                                                                  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea  <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                            <?php if($nna_p5_1_buenpracs == "No") { echo "readonly='true'"; } ?>

                                                            class="form-control" name="nna_p5_2_cualBuenpract" id="nna_p5_2_cualBuenpract" rows="10" cols="90" ><?php echo $nna_p5_2_cualBuenpract; ?></textarea>
                                                      ...
                                                      <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="indigenas_p6_tradulenind">Sí</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="indigenas_p6_tradulenind" id="indigenas_p6_tradulenind"
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="indigenas_p6_tradulenind">No</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                              <label class="form-check-label" for="indigenas_p6_2_convenio">
                                                              <input class="form-check-input" type="radio"
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                              ...
                                                              <label class="form-check-label" for="indigenas_p6_2_convenio_no">
                                                              <input class="form-check-input" type="radio"
                                                                  name="indigenas_p6_2_convenio" id="indigenas_p6_2_convenio_no"
                                                                  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea  <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                            <?php if($indigenas_p6_2_convenio == "No") { echo "readonly='true'"; } ?>

                                                            class="form-control" name="indigenas_p6_2_nombinst" id="indigenas_p6_2_nombinst" rows="10" cols="90" ><?php echo $indigenas_p6_2_nombinst; ?></textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          <div class="form-check form-check-inline">
                                                            <label class="form-check-label" for="indigenas_p6_5_buenaspract">  <input class="form-check-input" type="radio"
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                            <label class="form-check-label" for="indigenas_p6_5_buenaspract_no"><input class="form-check-input" type="radio"
                                                                  name="indigenas_p6_5_buenaspract" id="indigenas_p6_5_buenaspract_no"
                                                                  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea  <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                            <?php if($indigenas_p6_5_buenaspract == "No") { echo "readonly='true'"; } ?>


                                                            class="form-control" name="indigenas_p6_6_cualbuenaspra" id="indigenas_p6_6_cualbuenaspra" rows="10" cols="90" ><?php echo $indigenas_p6_6_cualbuenaspra; ?></textarea>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                          ...
                                                          <div class="form-check form-check-inline">
                                                            <label class="form-check-label"
                                                                for="extranjeras_p7_tradLenExt_no">  <input class="form-check-input" type="radio"
                                                                  name="extranjeras_p7_tradLenExt" id="extranjeras_p7_tradLenExt_no"
                                                                  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                        <div class="form-check form-check-inline">
                                                                                                                <label class="form-check-label"for="extranjeras_p7_2_ConvInst">
                                                                                                                    <input class="form-check-input" type="radio"
                                                                                                                ...
                                                                                                                <div class="form-check form-check-inline">
                                                                                                                  <label class="form-check-label" for="extranjeras_p7_2_ConvInst_no">
                                                                                                                    <input class="form-check-input" type="radio" name="extranjeras_p7_2_ConvInst" id="extranjeras_p7_2_ConvInst_no"
                                                                                                                        <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                    ...
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea  <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                            ...
                                                            class="form-control" name="extranjeras_p7_3_nombreInsti" id="extranjeras_p7_3_nombreInsti" rows="10" cols="90" ><?php echo $extranjeras_p7_3_nombreInsti; ?></textarea>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <?php if ($extranjeras_p7_4_interno == "Protocolo interno"){echo ' checked="checked"'; }?>/>
                                                          ...
                                                          ¿Cuáles? </label>
                                                          <input class="form-control group74" type="text"  name="extranjeras_p7_4_interno_cual"
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            class="form-check-input" type="checkbox"
                                                                ...
                                                                <?php if ($extranjeras_p7_4_ninguno == "Ninguno"){
                                                                  echo ' checked="checked"';
                                                                }?> />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input <?php if($estatus == 0){echo  "group74";}?>" type="checkbox" name="extranjeras_p7_4_Otro"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label"
                                                        for="extranjeras_p7_5_buenasprac">
                                                      <input class="form-check-input" type="radio"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label"
                                                        for="extranjeras_p7_5_buenasprac_no">
                                                      <input class="form-check-input" type="radio"
                                                      name="extranjeras_p7_5_buenasprac" id="extranjeras_p7_5_buenasprac_no"
                                                      <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea  <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                            <?php if($extranjeras_p7_5_buenasprac == "No") { echo "readonly='true'"; } ?>

                                                            class="form-control" name="extranjeras_p7_6_buenasprac_cual" id="extranjeras_p7_6_buenasprac_cual" rows="10" cols="90" ><?php echo $extranjeras_p7_6_buenasprac_cual; ?></textarea>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label"
                                                        for="discapacidad_p8_braile"><input class="form-check-input" type="radio"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label"
                                                        for="discapacidad_p8_braile_no"><input class="form-check-input" type="radio"
                                                      name="discapacidad_p8_braile" id="discapacidad_p8_braile_no"
                                                      <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                                                                            ...
                                                                                                            <div class="form-check form-check-inline">
                                                                                                              <label class="form-check-label"
                                                                                                              for="discapacidad_p8_LenSen"><input class="form-check-input" type="radio"
                                                                                                            ...
                                                                                                            <div class="form-check form-check-inline">
                                                                                                              <label class="form-check-label"
                                                                                                              for="discapacidad_p8_LenSen_no"><input class="form-check-input" type="radio"
                                                                                                            name="discapacidad_p8_LenSen" id="discapacidad_p8_LenSen_no"
                                                                                                            <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                          ...
                                                          ¿Cuáles? </label>
                                                          <input class="form-control group82" type="text"  name="discapacidad_p8_2_interno_cua"
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input <?php if($estatus == 0){echo  "group82";}?> " type="checkbox" name="discapacidad_p8_2_otros"
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label" for="discapacidad_p8_3_buenasprac">
                                                      <input class="form-check-input" type="radio"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label" for="discapacidad_p8_3_buenasprac_no">
                                                      <input class="form-check-input" type="radio"
                                                      name="discapacidad_p8_3_buenasprac" id="discapacidad_p8_3_buenasprac_no"
                                                      <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <textarea  <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                            <?php if($discapacidad_p8_3_buenasprac == "No") { echo "readonly='true'"; } ?>

                                                            class="form-control" name="discapacidad_p8_3_buenasprac_cual" id="discapacidad_p8_3_buenasprac_cual" rows="10" cols="90" ><?php echo $discapacidad_p8_3_buenasprac_cual; ?></textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label" for="colaboracion_p9_tipcol">
                                                      <input class="form-check-input" type="radio"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="colaboracion_p9_tipcol_no">
                                                      <input class="form-check-input" type="radio"
                                                      name="colaboracion_p9_tipcol" id="colaboracion_p9_tipcol_no"
                                                      <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea <?php if($estatus != 0) { echo "readonly='true'"; } ?>
                                                        <?php if($colaboracion_p9_tipcol == "No") { echo "readonly='true'"; } ?>


                                                        class="form-control" name="colaboracion_p9_1_instcol" id="colaboracion_p9_1_instcol" rows="10" cols="90" ><?php echo $colaboracion_p9_1_instcol; ?></textarea>
                                          ...
                                          <table class="table">
                                              <tbody>
                                                  <tr>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                    <div class="form-check form-check-inline">
                                                      <label class="form-check-label" for="registro_p10_intsispla">
                                                    <input class="form-check-input" type="radio"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                      <label class="form-check-label" for="registro_p10_intsispla_no">
                                                    <input class="form-check-input" type="radio"
                                                    name="registro_p10_intsispla" id="registro_p10_intsispla_no"
                                                    <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                              ...
                                              <tbody>
                                                  <tr>
                                                    ...
                                                    <textarea <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                      <?php if($registro_p10_intsispla == "No") { echo "readonly='true'"; } ?>


                                                      class="form-control" name="registro_p10_1_servsispl" id="registro_p10_1_servsispl" rows="10" cols="90" ><?php echo $registro_p10_1_servsispl; ?></textarea>
                                                  </tr>
                                              </tbody>
                                          </table>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label" for="indicadores_p11_modeval">
                                                          <input class="form-check-input" type="radio"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label" for="indicadores_p11_modeval_no">
                                                      <input class="form-check-input" type="radio"
                                                      name="indicadores_p11_modeval" id="indicadores_p11_modeval_no"
                                                      <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                        <?php if($indicadores_p11_modeval == "No") { echo "readonly='true'"; } ?>

                                                        class="form-control" name="indicadores_p11_1_cualind" id="indicadores_p11_1_cualind" rows="10" cols="90" ><?php echo $indicadores_p11_1_cualind; ?></textarea>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                        ...
                                                        class="form-control" name="transparencia_p12_1_cualpract" id="transparencia_p12_1_cualpract" rows="10" cols="90" ><?php echo $transparencia_p12_1_cualpract; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        <form action="#" method="post" class="col-lg-12">
                                            ...
                                            <div>
                                                ...
                                                <h5>15.- Número total de denuncias recibidas por la institución estatal de seguridad pública en el año 2020.</h5>
                                            </div>
                                            <table class="table">
                                                <tbody>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <div class="form-group col-md-6">
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label" for="victimas_p17_bprac">
                                                      <input class="form-check-input" type="radio"
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <label class="form-check-label" for="victimas_p17_bprac_no">
                                                      <input class="form-check-input" type="radio"
                                                      name="victimas_p17_bprac" id="victimas_p17_bprac_no"
                                                      <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                        <?php if($victimas_p17_bprac == "No") { echo "readonly='true'"; } ?>
                                                         class="form-control" name="victimas_p17_1_cuales" id="victimas_p17_1_cuales" rows="10" cols="90" ><?php echo $victimas_p17_1_cuales; ?></textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label" for="necesidades_p18_1_secsegpu">  <input class="form-check-input" type="checkbox"
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label" for="necesidades_p18_1_subsispen">      <input class="form-check-input" type="checkbox"
                                                        ...
                                                        <div class="form-check">
                                                          <label class="form-check-label" for="necesidades_p18_1_tautsup">    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label" for="necesidades_p18_1_tfisespm">  <input class="form-check-input" type="checkbox"
                                                        ...
                                                        <div class="form-check">
                                                        <label class="form-check-label" for="necesidades_p18_1_torgmec">      <input class="form-check-input" type="checkbox"
                                        ...
                                        <form action="#" method="post" class="col-lg-12">
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                              <label class="form-check-label" for="impacto_p19_medprev">
                                                                  <input class="form-check-input" type="radio"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                              <label class="form-check-label" for="impacto_p19_medprev_no">
                                                                <input class="form-check-input" type="radio"
                                                                    name="impacto_p19_medprev" id="impacto_p19_medprev_no"
                                                                    <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                      <textarea  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                        <?php if($impacto_p19_medprev == "No") { echo "readonly='true'"; } ?>

                                                        class="form-control" name="impacto_p19_1_medse" id="impacto_p19_1_medse" rows="10" cols="90" ><?php echo $impacto_p19_1_medse; ?></textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <div class="form-group col-md-6">
                                                            <div class="form-check form-check-inline">
                                                              <label class="form-check-label" for="impacto_p19_2_incmed">
                                                                <input class="form-check-input" type="radio"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                              <label class="form-check-label" for="impacto_p19_2_incmed_no">

                                                                <input class="form-check-input" type="radio"
                                                                    name="impacto_p19_2_incmed" id="impacto_p19_2_incmed_no"
                                                                    <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <textarea  <?php if($estatus != 0) { echo "disabled='true'"; } ?>
                                                                  ...
                                                                  <?php if($impacto_p19_2_incmed== "No") { echo "readonly='true'"; } ?>

                                                                  class="form-control" name="impacto_p19_3_descmed" id="impacto_p19_3_descmed" rows="10" cols="90" ><?php echo $impacto_p19_3_descmed; ?></textarea>
...
function showContent() {
  ...
  mujeres_p4_protoInterna = document.getElementById("mujeres_p4_protoInterna");
    if (mujeres_p4_protoInterna.checked) {
        ...
        document.getElementById("mujeres_p4_protoInterna_cual").value=null;
...
function showContent2() {
    ...
    if (mujeres_p4_interno.checked) {
        ...
        document.getElementById("mujeres_p4_interno_cua").value=null;
        element.style.display = 'none';
    }
}
...
function showContent400() {
    ...
    if (mujeres_p4_otroProtocolo.checked) {
        ...
        document.getElementById("mujeres_p4_otroProtocolo_cual").value=null;
        element.style.display = 'none';
    }
}
...
function showContent99() {
    ...
    if (nna_p5_otroProtocolo.checked) {
      ...
      document.getElementById("nna_p5_otroProtocolo_cual").value=null;
        element.style.display = 'none';
    }
}
...
function showContent11() {
    ...
    if (nna_p5_protoInterna.checked) {
      ...
      document.getElementById("nna_p5_protoInterna_cual").value=null;
        element.style.display = 'none';
...
function showContent22() {
    ...
    if (nna_p5_interno.checked) {
      ...
      document.getElementById("nna_p5_interno_cua").value=null;
        element.style.display = 'none';
    }
}
...
function showContent153() {
    ...
    if (necesidades_p15_3_otros.checked) {
      ...
      document.getElementById("necesidades_p15_3_cuales").value=null;
        element.style.display = 'none';
    }
}
...
$(function() {
    enable_cb12();
    $("#personal_p1_2_nosesabe").click(enable_cb12);
});

function enable_cb12() {
if (this.checked) {
        $("input.group12").attr("disabled", true).removeAttr("checked").val(" ");
    }else  {
      $("input.group12").attr("disabled", false);
    }
}
</script>
...
var txtar172 = document.getElementById('victimas_p17_1_cuales')
