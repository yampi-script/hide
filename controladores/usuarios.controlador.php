			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						$_SESSION["formularioDePolicias"] = $acceso["formularioDePolicias"];
						$_SESSION["formularioDeJueces"] = $acceso["formularioDeJueces"];
						$_SESSION["formularioDeFiscales"] = $acceso["formularioDeFiscales"];
						$_SESSION["formularioDeDefensores"] = $acceso["formularioDeDefensores"];
